 ...
 *          - For parameters 'InjectedSamplingTime', 'InjectedOffset', 'InjectedOffsetNumber', 'AutoInjectedConv': ADC
 * enabled without conversion on going on regular and injected groups.
 *          - For parameters 'InjectedChannel', 'InjectedRank', 'InjectedNbrOfConversion', 'ExternalTrigInjecConv',
 * 'ExternalTrigInjecConvEdge': ADC enabled and while conversion on going on ADC groups regular and injected. If ADC is
 * not in the appropriate state to modify some parameters, these parameters setting is bypassed without error reporting
 * (as it can be the expected behavior in case of intended action to update another parameter (which fulfills the ADC
 * state condition) on the fly).
 */
typedef struct
{
  uint32_t InjectedChannel; /*!< Specifies the channel to configure into ADC group injected.
                                 This parameter can be a value of @ref ADC_HAL_EC_CHANNEL
                                 Note: Depending on devices and ADC instances, some channels may not be available on
                               device package pins. Refer to device datasheet for channels availability. */
  ...
  uint32_t InjectedRank; /*!< Specifies the rank in the ADC group injected sequencer.
                              ...
                              Note: to disable a channel or change order of conversion sequencer, rank containing a
                            previous channel setting can be overwritten by the new channel setting (or parameter number
                            of conversions adjusted) */

  uint32_t InjectedSamplingTime; /*!< Sampling time value to be set for the selected channel.
                                      Unit: ADC clock cycles.
                                      Conversion time is the addition of sampling time and processing time
                                      (12.5 ADC clock cycles at ADC resolution 12 bits, 10.5 cycles at 10 bits, 8.5
                                    cycles at 8 bits, 6.5 cycles at 6 bits). This parameter can be a value of @ref
                                    ADC_HAL_EC_CHANNEL_SAMPLINGTIME. Caution: This parameter applies to a channel that
                                    can be used in a regular and/or injected group. It overwrites the last setting.
                                      Note: In case of usage of internal measurement channels (VrefInt/Vbat/TempSensor),
                                            sampling time constraints must be respected (sampling time can be adjusted
                                    in function of ADC clock frequency and sampling time setting) Refer to device
                                    datasheet for timings values. */

  uint32_t InjectedSingleDiff; /*!< Selection of single-ended or differential input.
                                    In differential mode: Differential measurement is between the selected channel 'i'
                                  (positive input) and channel 'i+1' (negative input). Only channel 'i' has to be
                                  configured, channel 'i+1' is configured automatically. This parameter must be a value
                                  of @ref ADC_HAL_EC_CHANNEL_SINGLE_DIFF_ENDING. Caution: This parameter applies to a
                                  channel that can be used in a regular and/or injected group. It overwrites the last
                                  setting. Note: Refer to Reference Manual to ensure the selected channel is available
                                  in differential mode. Note: When configuring a channel 'i' in differential mode, the
                                  channel 'i+1' is not usable separately. Note: This parameter must be modified when ADC
                                  is disabled (before ADC start conversion or after ADC stop conversion). If ADC is
  ...
  uint32_t InjectedOffset; /*!< Defines the offset to be subtracted from the raw converted data.
                              ...
                              number between Min_Data = 0x000 and Max_Data = 0xFFF,  0x3FF, 0xFF or 0x3F respectively.
                                Note: This parameter must be modified when no conversion is on going on both regular and
                              injected groups (ADC disabled, or ADC enabled without continuous mode or external trigger
  ...
  uint32_t InjectedNbrOfConversion; /*!< Specifies the number of ranks that will be converted within the ADC group
                                       injected sequencer. To use the injected group sequencer and convert several
                                       ranks, parameter 'ScanConvMode' must be enabled. This parameter must be a number
                                       ...
                                       a channel on injected group can impact the configuration of other channels
                                       previously set. */

  FunctionalState InjectedDiscontinuousConvMode; /*!< Specifies whether the conversions sequence of ADC group injected
                                               is performed in Complete-sequence/Discontinuous-sequence (main sequence
                                               subdivided in successive parts). Discontinuous mode is used only if
                                               sequencer is enabled (parameter 'ScanConvMode'). If sequencer is
                                               disabled, this parameter is discarded. Discontinuous mode can be enabled
                                               only if continuous mode is disabled. This parameter can be set to ENABLE
                                               or DISABLE. Note: This parameter must be modified when ADC is disabled
                                               (before ADC start conversion or after ADC stop conversion). Note: For
                                               injected group, discontinuous mode converts the sequence channel by
                                               channel (discontinuous length fixed to 1 rank). Caution: this setting
  ...
  FunctionalState AutoInjectedConv; /*!< Enables or disables the selected ADC group injected automatic conversion after
                                       ...
                                       must be disabled ('ExternalTrigInjecConv' set to ADC_INJECTED_SOFTWARE_START)
                                         Note: In case of DMA used with regular group: if DMA configured in normal mode
                                       (single shot) JAUTO will be stopped upon DMA transfer complete. To maintain JAUTO
                                       always enabled, DMA must be configured in circular mode. Caution: this setting
                                       impacts the entire injected group. Therefore, call of
  ...
  FunctionalState QueueInjectedContext; /*!< Specifies whether the context queue feature is enabled.
                                             ...
                                             If context queue is enabled, injected sequencer&channels configurations are
                                           queued on up to 2 contexts. If a new injected context is set when queue is
                                           full, error is triggered by interruption and through function
                                             'HAL_ADCEx_InjectedQueueOverflowCallback'.
                                             Caution: This feature request that the sequence is fully configured before
                                           injected conversion start. Therefore, configure channels with as many calls
                                           to HAL_ADCEx_InjectedConfigChannel() as the 'InjectedNbrOfConversion'
                                           parameter. Caution: this setting impacts the entire injected group.
                                           Therefore, call of HAL_ADCEx_InjectedConfigChannel() to configure a channel
                                           on injected group can impact the configuration of other channels previously
                                           set. Note: This parameter must be modified when ADC is disabled (before ADC
                                           start conversion or after ADC stop conversion). */

  uint32_t ExternalTrigInjecConv; /*!< Selects the external event used to trigger the conversion start of injected
                                     group. If set to ADC_INJECTED_SOFTWARE_START, external triggers are disabled and
                                     software trigger is used instead. This parameter can be a value of @ref
                                     ADC_injected_external_trigger_source. Caution: this setting impacts the entire
                                     injected group. Therefore, call of HAL_ADCEx_InjectedConfigChannel() to configure a
  ...
  uint32_t ExternalTrigInjecConvEdge; /*!< Selects the external trigger edge of injected group.
                                           ...
                                           If trigger source is set to ADC_INJECTED_SOFTWARE_START, this parameter is
                                         discarded. Caution: this setting impacts the entire injected group. Therefore,
                                         call of HAL_ADCEx_InjectedConfigChannel() to configure a channel on injected
                                         group can impact the configuration of other channels previously set. */
 ...
 * (both Master and Slave ADCs). Both Master and Slave ADCs must be disabled.
 */
typedef struct
{
  ...
  uint32_t DMAAccessMode; /*!< Configures the DMA mode for multimode ADC:
                             ...
                             (one DMA channel for both ADC, DMA of ADC master) This parameter can be a value of @ref
...
#define ADC_INJECTED_SOFTWARE_START                                                                                    \
  (LL_ADC_INJ_TRIG_SOFTWARE) /*!< Software triggers injected group conversion start                                    \
                              */
#define ADC_EXTERNALTRIGINJEC_T1_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM1_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM1 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T1_TRGO2                                                                                 \
  (LL_ADC_INJ_TRIG_EXT_TIM1_TRGO2) /*!< ADC group injected conversion trigger from external peripheral: TIM1 TRGO2.    \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T1_CC4                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM1_CH4) /*!< ADC group injected conversion trigger from external peripheral: TIM1 channel 4   \
...
#define ADC_EXTERNALTRIGINJEC_T2_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM2_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM2 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T2_CC1                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM2_CH1) /*!< ADC group injected conversion trigger from external peripheral: TIM2 channel 1   \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM3_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM3 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC1                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM3_CH1) /*!< ADC group injected conversion trigger from external peripheral: TIM3 channel 1   \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC3                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM3_CH3) /*!< ADC group injected conversion trigger from external peripheral: TIM3 channel 3   \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC4                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM3_CH4) /*!< ADC group injected conversion trigger from external peripheral: TIM3 channel 4   \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T4_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM4_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM4 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T6_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM6_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM6 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T8_CC4                                                                                   \
  (LL_ADC_INJ_TRIG_EXT_TIM8_CH4) /*!< ADC group injected conversion trigger from external peripheral: TIM8 channel 4   \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T8_TRGO                                                                                  \
  (LL_ADC_INJ_TRIG_EXT_TIM8_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM8 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T8_TRGO2                                                                                 \
  (LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2) /*!< ADC group injected conversion trigger from external peripheral: TIM8 TRGO2.    \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T15_TRGO                                                                                 \
  (LL_ADC_INJ_TRIG_EXT_TIM15_TRGO) /*!< ADC group injected conversion trigger from external peripheral: TIM15 TRGO.    \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_EXT_IT15                                                                                 \
  (LL_ADC_INJ_TRIG_EXT_EXTI_LINE15) /*!< ADC group injected conversion trigger from external peripheral: external      \
...
#define ADC_EXTERNALTRIGINJECCONV_EDGE_RISING                                                                          \
  (ADC_JSQR_JEXTEN_0) /*!< Injected conversions hardware trigger detection on the rising edge                   */
#define ADC_EXTERNALTRIGINJECCONV_EDGE_FALLING                                                                         \
  (ADC_JSQR_JEXTEN_1) /*!< Injected conversions hardware trigger detection on the falling edge                  */
#define ADC_EXTERNALTRIGINJECCONV_EDGE_RISINGFALLING                                                                   \
  (ADC_JSQR_JEXTEN) /*!< Injected conversions hardware trigger detection on both the rising and falling edges */
/**
 * @}
 */
...
#define ADC_OFFSET_NONE                                                                                                \
  (ADC_OFFSET_4 + 1U) /*!< ADC offset disabled: no offset correction for the selected ADC channel */
#define ADC_OFFSET_1                                                                                                   \
  (LL_ADC_OFFSET_1) /*!< ADC offset number 1: ADC channel and offset level to which the offset programmed will be      \
                       applied (independently of channel mapped on ADC group regular or group injected) */
#define ADC_OFFSET_2                                                                                                   \
  (LL_ADC_OFFSET_2) /*!< ADC offset number 2: ADC channel and offset level to which the offset programmed will be      \
                       applied (independently of channel mapped on ADC group regular or group injected) */
#define ADC_OFFSET_3                                                                                                   \
  (LL_ADC_OFFSET_3) /*!< ADC offset number 3: ADC channel and offset level to which the offset programmed will be      \
                       applied (independently of channel mapped on ADC group regular or group injected) */
#define ADC_OFFSET_4                                                                                                   \
  (LL_ADC_OFFSET_4) /*!< ADC offset number 4: ADC channel and offset level to which the offset programmed will be      \
                       applied (independently of channel mapped on ADC group regular or group injected) */
/**
 * @}
 */
...
#define ADC_DUALMODE_ALTERTRIG                                                                                         \
  (LL_ADC_MULTI_DUAL_INJ_ALTERN) /*!< ADC dual mode enabled: group injected alternate trigger. Works only with         \
                                    external triggers (not internal SW start) */
#define ADC_DUALMODE_REGSIMULT_INJECSIMULT                                                                             \
  (LL_ADC_MULTI_DUAL_REG_SIM_INJ_SIM) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected \
                                         simultaneous */
#define ADC_DUALMODE_REGSIMULT_ALTERTRIG                                                                               \
  (LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected \
                                         alternate trigger */
#define ADC_DUALMODE_REGINTERL_INJECSIMULT                                                                             \
  (LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM) /*!< ADC dual mode enabled: Combined group regular interleaved + group injected  \
                                         simultaneous */
...
#define ADC_DMAACCESSMODE_12_10_BITS                                                                                   \
  (ADC_CCR_MDMA_1) /*!< DMA multimode enabled (one DMA channel for both ADC, DMA of ADC master) for 12 and 10 bits     \
                      resolution */
#define ADC_DMAACCESSMODE_8_6_BITS                                                                                     \
  (ADC_CCR_MDMA) /*!< DMA multimode enabled (one DMA channel for both ADC, DMA of ADC master) for 8 and 6 bits         \
                    resolution */
/**
 * @}
 */
...
#define ADC_CFGR_FIELDS                                                                                                \
  (ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL | ADC_CFGR_JQM |           \
   ...
   ADC_CFGR_EXTEN | ADC_CFGR_EXTSEL | ADC_CFGR_ALIGN | ADC_CFGR_RES | ADC_CFGR_DFSDMCFG | ADC_CFGR_DMACFG |            \
   ADC_CFGR_DMAEN)
#else
#define ADC_CFGR_FIELDS                                                                                                \
  (ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL | ADC_CFGR_JQM |           \
...
#define ADC_SMPR1_FIELDS                                                                                               \
  (ADC_SMPR1_SMP9 | ADC_SMPR1_SMP8 | ADC_SMPR1_SMP7 | ADC_SMPR1_SMP6 | ADC_SMPR1_SMP5 | ADC_SMPR1_SMP4 |               \
   ADC_SMPR1_SMP3 | ADC_SMPR1_SMP2 | ADC_SMPR1_SMP1 | ADC_SMPR1_SMP0 | ADC_SMPR1_SMPPLUS)
#else
#define ADC_SMPR1_FIELDS                                                                                               \
  (ADC_SMPR1_SMP9 | ADC_SMPR1_SMP8 | ADC_SMPR1_SMP7 | ADC_SMPR1_SMP6 | ADC_SMPR1_SMP5 | ADC_SMPR1_SMP4 |               \
...
#define ADC_DFSDM_MODE_ENABLE                                                                                          \
  (LL_ADC_REG_DFSDM_TRANSFER_ENABLE) /*!< ADC conversion data are transferred to DFSDM for post processing. The ADC    \
                                        conversion data format must be 16-bit signed and right aligned, refer to       \
                                        reference manual. DFSDM transfer cannot be used if DMA transfer is enabled. */
/**
 * @}
 */
#endif /* ADC_CFGR_DFSDMCFG */
...
#define ADC_IS_INDEPENDENT(__HANDLE__) (((((__HANDLE__)->Instance) == ADC3)) ? SET : RESET)
...
#endif /* (STM32L471xx) || defined (STM32L475xx) || defined (STM32L476xx) || defined (STM32L485xx) || defined          \
          (STM32L486xx) || defined (STM32L496xx) || defined (STM32L4A6xx) */
...
#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                                                  \
  CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR, ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATEN |   \
                                                                       ADC_CCR_TSEN | ADC_CCR_VREFEN | ADC_CCR_MDMA |  \
                                                                       ADC_CCR_DMACFG | ADC_CCR_DELAY | ADC_CCR_DUAL)
#else
#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                                                  \
  CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR,                                                     \
            ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATEN | ADC_CCR_TSEN | ADC_CCR_VREFEN)

#endif /* ADC_MULTIMODE_SUPPORT */

#if defined(STM32L412xx) || defined(STM32L422xx) || defined(STM32L471xx) || defined(STM32L475xx) ||                    \
 ...
 * @note if __HANDLE_MASTER__ is the handle of a slave ADC or an independent ADC, __HANDLE_SLAVE__ instance is set to
 * NULL.
 * @retval None
 */
...
#endif /* defined (STM32L412xx) || defined (STM32L422xx) || defined (STM32L471xx) || defined (STM32L475xx) || defined  \
...
#endif /* (STM32L412xx) || defined (STM32L422xx) || defined (STM32L431xx) || defined (STM32L432xx) || defined          \
          (STM32L433xx) || defined (STM32L442xx) || defined (STM32L443xx) || defined (STM32L451xx) || defined          \
          (STM32L452xx) || defined (STM32L462xx) || defined (STM32L4P5xx) || defined (STM32L4Q5xx) || defined          \
          (STM32L4R5xx) || defined (STM32L4R7xx) || defined (STM32L4R9xx) || defined (STM32L4S5xx) || defined          \
 ...
 * @retval SET (__LENGTH__ is within the maximum number of possible programmable injected conversions) or RESET
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                        \
  ((((__HANDLE__)->Instance) == ADC1) &&                                                                               \
   (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) ||        \
    ...
    ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) ||     \
    ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||     \
    ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_18) ||     \
    ((__CHANNEL__) == ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) ||                             \
    ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1) ||                                   \
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                        \
  (((((__HANDLE__)->Instance) == ADC1) &&                                                                              \
    (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) ||       \
     ...
     ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT) ||                                    \
     ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT))) ||                             \
   ((((__HANDLE__)->Instance) == ADC2) &&                                                                              \
    (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) ||       \
     ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_7) || ((__CHANNEL__) == ADC_CHANNEL_8) ||       \
     ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) ||     \
     ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_15) || ((__CHANNEL__) == ADC_CHANNEL_16))))
  ...
  (((((__HANDLE__)->Instance) == ADC1) &&                                                                              \
   ...
   ((((__HANDLE__)->Instance) == ADC2) &&                                                                              \
    (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) ||       \
     ...
     ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_18) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1_ADC2) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH2_ADC2))))
#elif defined(STM32L471xx) || defined(STM32L475xx) || defined(STM32L476xx) || defined(STM32L485xx) ||                  \
    defined(STM32L486xx) || defined(STM32L496xx) || defined(STM32L4A6xx)
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                        \
  (((((__HANDLE__)->Instance) == ADC1) &&                                                                              \
   ...
   ((((__HANDLE__)->Instance) == ADC3) &&                                                                              \
    (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) ||       \
     ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) ||       \
     ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) ||      \
     ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) ||    \
     ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||                                         \
     ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) ||                               \
     ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH2_ADC3))))
#endif /* (STM32L431xx) || defined (STM32L432xx) || defined (STM32L433xx) || defined (STM32L442xx) || defined          \
          (STM32L443xx) || defined (STM32L451xx) || defined (STM32L452xx) || defined (STM32L462xx) || defined          \
          (STM32L4R5xx) || defined (STM32L4R7xx) || defined (STM32L4R9xx) || defined (STM32L4S5xx) || defined          \
          (STM32L4S7xx) || defined (STM32L4S9xx) */
...
#define IS_ADC_EXTTRIGINJEC_EDGE(__EDGE__)                                                                             \
  (((__EDGE__) == ADC_EXTERNALTRIGINJECCONV_EDGE_NONE) || ((__EDGE__) == ADC_EXTERNALTRIGINJECCONV_EDGE_RISING) ||     \
...
#define IS_ADC_DMA_ACCESS_MULTIMODE(__MODE__)                                                                          \
  (((__MODE__) == ADC_DMAACCESSMODE_DISABLED) || ((__MODE__) == ADC_DMAACCESSMODE_12_10_BITS) ||                       \
...
#define IS_ADC_ANALOG_WATCHDOG_MODE(__WATCHDOG_MODE__)                                                                 \
  (((__WATCHDOG_MODE__) == ADC_ANALOGWATCHDOG_NONE) || ((__WATCHDOG_MODE__) == ADC_ANALOGWATCHDOG_SINGLE_REG) ||       \
   ...
   ((__WATCHDOG_MODE__) == ADC_ANALOGWATCHDOG_ALL_REG) || ((__WATCHDOG_MODE__) == ADC_ANALOGWATCHDOG_ALL_INJEC) ||     \
...
#define IS_ADC_EVENT_TYPE(__EVENT__)                                                                                   \
  (((__EVENT__) == ADC_EOSMP_EVENT) || ((__EVENT__) == ADC_AWD_EVENT) || ((__EVENT__) == ADC_AWD2_EVENT) ||            \
   ((__EVENT__) == ADC_AWD3_EVENT) || ((__EVENT__) == ADC_OVR_EVENT) || ((__EVENT__) == ADC_JQOVF_EVENT))
