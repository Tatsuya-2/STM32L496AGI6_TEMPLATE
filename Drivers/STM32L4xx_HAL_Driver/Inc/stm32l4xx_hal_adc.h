 ...
 *          - For parameters 'LowPowerAutoWait' and 'DMAContinuousRequests': ADC enabled without conversion on going on
 * groups regular and injected. If ADC is not in the appropriate state to modify some parameters, these parameters
 * setting is bypassed without error reporting (as it can be the expected behavior in case of intended action to update
 * another parameter (which fulfills the ADC state condition) on the fly).
 */
typedef struct
{
  uint32_t ClockPrescaler; /*!< Select ADC clock source (synchronous clock derived from APB clock or asynchronous clock
                              derived from system clock or PLL (Refer to reference manual for list of clocks available))
                              and clock prescaler. This parameter can be a value of @ref ADC_HAL_EC_COMMON_CLOCK_SOURCE.
                                Note: The ADC clock configuration is common to all ADC instances.
                                Note: In case of usage of channels on injected group, ADC frequency should be lower than
                              AHB clock frequency /4 for resolution 12 or 10 bits, AHB clock frequency /3 for resolution
                              8 bits, AHB clock frequency /2 for resolution 6 bits. Note: In case of synchronous clock
                              mode based on HCLK/1, the configuration must be enabled only if the system clock has a 50%
                              duty clock cycle (APB prescaler configured inside RCC must be bypassed and PCLK clock must
                              have 50% duty cycle). Refer to reference manual for details. Note: In case of usage of
                              asynchronous clock, the selected clock must be preliminarily enabled at RCC top level.
  ...
  uint32_t ScanConvMode; /*!< Configure the sequencer of ADC groups regular and injected.
                            ...
                            sequence subdivided in successive parts. If disabled: Conversion is performed in single mode
                            (one channel converted, the one defined in rank 1). Parameters 'NbrOfConversion' and
                            'InjectedNbrOfConversion' are discarded (equivalent to set to 1). If enabled:  Conversions
                            are performed in sequence mode (multiple ranks defined by 'NbrOfConversion' or
                            'InjectedNbrOfConversion' and rank of each channel in sequencer). Scan direction is upward:
                            from rank 1 to rank 'n'. This parameter can be a value of @ref ADC_Scan_mode */

  uint32_t EOCSelection; /*!< Specify which EOC (End Of Conversion) flag is used for conversion by polling and
                            interruption: end of unitary conversion or end of sequence conversions. This parameter can
                            be a value of @ref ADC_EOCSelection. */
  ...
  FunctionalState LowPowerAutoWait; /*!< Select the dynamic low power Auto Delay: new conversion start only when the
                                       ...
                                       or HAL_ADCEx_InjectedGetValue(). This feature automatically adapts the frequency
                                       of ADC conversions triggers to the speed of the system that reads the data.
                                       Moreover, this avoids risk of overrun for low frequency applications. This
                                       parameter can be set to ENABLE or DISABLE. Note: It is not recommended to use
                                       with interruption or DMA (HAL_ADC_Start_IT(), HAL_ADC_Start_DMA()) since these
                                       modes have to clear immediately the EOC flag (by CPU to free the IRQ pending
                                       event or by DMA). Auto wait will work but fort a very short time, discarding its
                                       intended benefit (except specific case of high load of CPU or DMA transfers which
                                       can justify usage of auto wait). Do use with polling: 1. Start conversion with
                                       ...
                                       start. (in case of usage of ADC group injected, use the equivalent functions
  ...
  FunctionalState ContinuousConvMode; /*!< Specify whether the conversion is performed in single mode (one conversion)
                                       ...
                                       trigger occurred (software start or external trigger). This parameter can be set
                                       to ENABLE or DISABLE. */

  uint32_t NbrOfConversion; /*!< Specify the number of ranks that will be converted within the regular group sequencer.
                                 To use the regular group sequencer and convert several ranks, parameter 'ScanConvMode'
                               must be enabled. This parameter must be a number between Min_Data = 1 and Max_Data = 16.
                                 Note: This parameter must be modified when no conversion is on going on regular group
                               (ADC disabled, or ADC enabled without continuous mode or external trigger that could
                               launch a conversion). */
  ...
  FunctionalState DiscontinuousConvMode; /*!< Specify whether the conversions sequence of ADC group regular is performed
                                       ...
                                       discarded. Discontinuous mode can be enabled only if continuous mode is disabled.
                                       If continuous mode is enabled, this parameter setting is discarded. This
                                       parameter can be set to ENABLE or DISABLE. */

  uint32_t NbrOfDiscConversion; /*!< Specifies the number of discontinuous conversions in which the main sequence of ADC
                                   group regular (parameter NbrOfConversion) will be subdivided. If parameter
                                   'DiscontinuousConvMode' is disabled, this parameter is discarded. This parameter must
                                   be a number between Min_Data = 1 and Max_Data = 8. */

  uint32_t ExternalTrigConv; /*!< Select the external event source used to trigger ADC group regular conversion start.
                                  If set to ADC_SOFTWARE_START, external triggers are disabled and software trigger is
                                used instead. This parameter can be a value of @ref ADC_regular_external_trigger_source.
  ...
  FunctionalState DMAContinuousRequests; /*!< Specify whether the DMA requests are performed in one shot mode (DMA
                                       transfer stops when number of conversions is reached) or in continuous mode (DMA
                                       transfer unlimited, whatever number of conversions). This parameter can be set to
                                       ENABLE or DISABLE. Note: In continuous mode, DMA must be configured in circular
                                       mode. Otherwise an overrun will be triggered when DMA buffer maximum pointer is
                                       reached. */
  ...
  uint32_t Overrun; /*!< Select the behavior in case of overrun: data overwritten or preserved (default).
                         ...
                         Note: In case of overrun set to data preserved and usage with programming model with
                       interruption (HAL_Start_IT()): ADC IRQ handler has to clear end of conversion flags, this induces
                       the release of the preserved data. If needed, this data can be saved in function
                         HAL_ADC_ConvCpltCallback(), placed in user program code (called before end of conversion flags
                       clear). Note: Error reporting with respect to the conversion mode:
                               - Usage with ADC conversion by polling for event or interruption: Error is reported only
                       if overrun is set to data preserved. If overrun is set to data overwritten, user can willingly
                       not read all the converted data, this is not considered as an erroneous case.
                               - Usage with ADC conversion by DMA: Error is reported whatever overrun setting (DMA is
                       expected to process all data from data register). */
  ...
  ADC_OversamplingTypeDef Oversampling; /*!< Specify the Oversampling parameters.
                                             Caution: this setting overwrites the previous oversampling configuration if
                                           oversampling is already enabled. */
  ...
  uint32_t DFSDMConfig; /*!< Specify whether ADC conversion data is sent directly to DFSDM.
                             ...
                             Note: This parameter can be modified only if there is no conversion is ongoing (both
 ...
 * regular and injected groups. If ADC is not in the appropriate state to modify some parameters, these parameters
 * setting is bypassed without error reporting (as it can be the expected behavior in case of intended action to update
 * another parameter (which fulfills the ADC state condition) on the fly).
 */
typedef struct
{
  uint32_t Channel; /*!< Specify the channel to configure into ADC regular group.
                         ...
                         Note: Depending on devices and ADC instances, some channels may not be available on device
  ...
  uint32_t Rank; /*!< Specify the rank in the regular group sequencer.
                      ...
                      Note: to disable a channel or change order of conversion sequencer, rank containing a previous
                    channel setting can be overwritten by the new channel setting (or parameter number of conversions
                    adjusted) */

  uint32_t SamplingTime; /*!< Sampling time value to be set for the selected channel.
                              Unit: ADC clock cycles
                              Conversion time is the addition of sampling time and processing time
                              (12.5 ADC clock cycles at ADC resolution 12 bits, 10.5 cycles at 10 bits, 8.5 cycles at 8
                            bits, 6.5 cycles at 6 bits). This parameter can be a value of @ref
                            ADC_HAL_EC_CHANNEL_SAMPLINGTIME Caution: This parameter applies to a channel that can be
                            used into regular and/or injected group. It overwrites the last setting. Note: In case of
                            usage of internal measurement channels (VrefInt/Vbat/TempSensor), sampling time constraints
                            must be respected (sampling time can be adjusted in function of ADC clock frequency and
  ...
  uint32_t SingleDiff; /*!< Select single-ended or differential input.
                            In differential mode: Differential measurement is carried out between the selected channel
                          'i' (positive input) and channel 'i+1' (negative input). Only channel 'i' has to be
                          configured, channel 'i+1' is configured automatically. This parameter must be a value of @ref
                          ADC_HAL_EC_CHANNEL_SINGLE_DIFF_ENDING Caution: This parameter applies to a channel that can be
                          used in a regular and/or injected group. It overwrites the last setting. Note: Refer to
                          Reference Manual to ensure the selected channel is available in differential mode. Note: When
                          configuring a channel 'i' in differential mode, the channel 'i+1' is not usable separately.
                            Note: This parameter must be modified when ADC is disabled (before ADC start conversion or
                          after ADC stop conversion). If ADC is enabled, this parameter setting is bypassed without
                          error reporting (as it can be the expected behavior in case of another parameter update on the
                          fly) */
  ...
  uint32_t Offset; /*!< Define the offset to be subtracted from the raw converted data.
                      ...
                      between Min_Data = 0x000 and Max_Data = 0xFFF, 0x3FF, 0xFF or 0x3F respectively. Note: This
                      parameter must be modified when no conversion is on going on both regular and injected groups (ADC
                      disabled, or ADC enabled without continuous mode or external trigger that could launch a
                      conversion). */
...
typedef struct
{
  uint32_t WatchdogNumber; /*!< Select which ADC analog watchdog is monitoring the selected channel.
                                For Analog Watchdog 1: Only 1 channel can be monitored (or overall group of channels by
                              setting parameter 'WatchdogMode') For Analog Watchdog 2 and 3: Several channels can be
                              monitored (by successive calls of 'HAL_ADC_AnalogWDGConfig()' for each channel) This
                              parameter can be a value of @ref ADC_HAL_EC_AWD_NUMBER. */

  uint32_t WatchdogMode; /*!< Configure the ADC analog watchdog mode: single/all/none channels.
                              For Analog Watchdog 1: Configure the ADC analog watchdog mode: single channel or all
                            channels, ADC groups regular and-or injected. For Analog Watchdog 2 and 3: Several channels
                            can be monitored by applying successively the AWD init structure. Channels on ADC group
                            regular and injected are not differentiated: Set value 'ADC_ANALOGWATCHDOG_SINGLE_xxx' to
                            monitor 1 channel, value 'ADC_ANALOGWATCHDOG_ALL_xxx' to monitor all channels,
                            'ADC_ANALOGWATCHDOG_NONE' to monitor no channel. This parameter can be a value of @ref
                            ADC_analog_watchdog_mode. */

  uint32_t Channel; /*!< Select which ADC channel to monitor by analog watchdog.
                         For Analog Watchdog 1: this parameter has an effect only if parameter 'WatchdogMode' is
                       configured on single channel (only 1 channel can be monitored). For Analog Watchdog 2 and 3:
                       Several channels can be monitored. To use this feature, call successively the function
                       HAL_ADC_AnalogWDGConfig() for each channel to be added (or removed with value
                       'ADC_ANALOGWATCHDOG_NONE'). This parameter can be a value of @ref ADC_HAL_EC_CHANNEL. */
  ...
  uint32_t HighThreshold; /*!< Configure the ADC analog watchdog High threshold value.
                             ...
                             number between Min_Data = 0x000 and Max_Data = 0xFFF, 0x3FF, 0xFF or 0x3F respectively.
                               Note: Analog watchdog 2 and 3 are limited to a resolution of 8 bits: if ADC resolution is
                             12 bits the 4 LSB are ignored, if ADC resolution is 10 bits the 2 LSB are ignored. Note: If
                             ADC oversampling is enabled, ADC analog watchdog thresholds are impacted: the comparison of
                             analog watchdog thresholds is done on oversampling final computation (after ratio and shift
...
#define HAL_ADC_STATE_BUSY_INTERNAL                                                                                    \
  (0x00000002UL) /*!< ADC is busy due to an internal process (initialization, calibration) */
...
#define HAL_ADC_STATE_REG_BUSY                                                                                         \
  (0x00000100UL) /*!< A conversion on ADC group regular is ongoing or can occur (either by continuous mode,            \
                      external trigger, low power auto power-on (if feature available), multimode ADC master control   \
...
#define HAL_ADC_STATE_INJ_BUSY                                                                                         \
  (0x00001000UL) /*!< A conversion on ADC group injected is ongoing or can occur (either by auto-injection mode,       \
                      external trigger, low power auto power-on (if feature available), multimode ADC master control   \
                    (if feature available)) */
...
#define HAL_ADC_STATE_MULTIMODE_SLAVE                                                                                  \
  (0x00100000UL) /*!< ADC in multimode slave state, controlled by another ADC master (when feature available) */
...
#define ADC_EXTERNALTRIG_T1_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM1_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM1 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T1_TRGO2                                                                                      \
  (LL_ADC_REG_TRIG_EXT_TIM1_TRGO2) /*!< ADC group regular conversion trigger from external peripheral: TIM1 TRGO2.     \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T1_CC1                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM1_CH1) /*!< ADC group regular conversion trigger from external peripheral: TIM1 channel 1    \
...
#define ADC_EXTERNALTRIG_T1_CC2                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM1_CH2) /*!< ADC group regular conversion trigger from external peripheral: TIM1 channel 2    \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIG_T1_CC3                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM1_CH3) /*!< ADC group regular conversion trigger from external peripheral: TIM1 channel 3    \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIG_T2_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM2_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM2 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T2_CC2                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM2_CH2) /*!< ADC group regular conversion trigger from external peripheral: TIM2 channel 2    \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIG_T3_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM3_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM3 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T3_CC4                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM3_CH4) /*!< ADC group regular conversion trigger from external peripheral: TIM3 channel 4    \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIG_T4_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM4_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM4 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T4_CC4                                                                                        \
  (LL_ADC_REG_TRIG_EXT_TIM4_CH4) /*!< ADC group regular conversion trigger from external peripheral: TIM4 channel 4    \
                                    event (capture compare: input capture or output capture). Trigger edge set to      \
                                    rising edge (default setting). */
#define ADC_EXTERNALTRIG_T6_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM6_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM6 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T8_TRGO                                                                                       \
  (LL_ADC_REG_TRIG_EXT_TIM8_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM8 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T8_TRGO2                                                                                      \
  (LL_ADC_REG_TRIG_EXT_TIM8_TRGO2) /*!< ADC group regular conversion trigger from external peripheral: TIM8 TRGO2.     \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_T15_TRGO                                                                                      \
  (LL_ADC_REG_TRIG_EXT_TIM15_TRGO) /*!< ADC group regular conversion trigger from external peripheral: TIM15 TRGO.     \
                                      Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIG_EXT_IT11                                                                                      \
  (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger from external peripheral: external       \
...
#define ADC_EXTERNALTRIGCONVEDGE_RISINGFALLING                                                                         \
  (LL_ADC_REG_TRIG_EXT_RISINGFALLING) /*!< ADC group regular conversion trigger polarity set to both rising and        \
                                         falling edges */
/**
 * @}
 */
...
#define ADC_SAMPLETIME_3CYCLES_5                                                                                       \
  (ADC_SMPR1_SMPPLUS | LL_ADC_SAMPLINGTIME_2CYCLES_5) /*!< Sampling time 3.5 ADC clock cycles. If selected, this       \
                                                         sampling time replaces all sampling time 2.5 ADC clock        \
                                                         cycles. These 2 sampling times cannot be used simultaneously. \
                                                       */
...
#define ADC_CHANNEL_VBAT                                                                                               \
  (LL_ADC_CHANNEL_VBAT) /*!< ADC internal channel connected to Vbat/3: Vbat voltage through a divider ladder of factor \
                           1/3 to have Vbat always below Vdda. */
#if defined(ADC1) && !defined(ADC2)
#define ADC_CHANNEL_DAC1CH1                                                                                            \
  (LL_ADC_CHANNEL_DAC1CH1) /*!< ADC internal channel connected to DAC1 channel 1, channel specific to ADC1. This       \
                              channel is shared with ADC internal channel connected to temperature sensor, selection   \
                              is done using function @ref LL_ADC_SetCommonPathInternalCh(). */
#define ADC_CHANNEL_DAC1CH2                                                                                            \
  (LL_ADC_CHANNEL_DAC1CH2) /*!< ADC internal channel connected to DAC1 channel 2, channel specific to ADC1. This       \
                              channel is shared with ADC internal channel connected to Vbat, selection is done using   \
                              function @ref LL_ADC_SetCommonPathInternalCh(). */
#elif defined(ADC2)
#define ADC_CHANNEL_DAC1CH1_ADC2                                                                                       \
  (LL_ADC_CHANNEL_DAC1CH1_ADC2) /*!< ADC internal channel connected to DAC1 channel 1, channel specific to ADC2 */
#define ADC_CHANNEL_DAC1CH2_ADC2                                                                                       \
  (LL_ADC_CHANNEL_DAC1CH2_ADC2) /*!< ADC internal channel connected to DAC1 channel 2, channel specific to ADC2 */
#if defined(ADC3)
#define ADC_CHANNEL_DAC1CH1_ADC3                                                                                       \
  (LL_ADC_CHANNEL_DAC1CH1_ADC3) /*!< ADC internal channel connected to DAC1 channel 1, channel specific to ADC3 */
#define ADC_CHANNEL_DAC1CH2_ADC3                                                                                       \
  (LL_ADC_CHANNEL_DAC1CH2_ADC3) /*!< ADC internal channel connected to DAC1 channel 2, channel specific to ADC3 */
#endif                          /* ADC3 */
#endif                          /* ADC1 && !ADC2 */
/**
 * @}
...
#define ADC_ANALOGWATCHDOG_SINGLE_REG                                                                                  \
  (ADC_CFGR_AWD1SGL | ADC_CFGR_AWD1EN) /*!< Analog watchdog applied to a regular group single channel               */
...
#define ADC_ANALOGWATCHDOG_SINGLE_REGINJEC                                                                             \
  (ADC_CFGR_AWD1SGL | ADC_CFGR_AWD1EN | ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to a regular and injected       \
...
#define ADC_ANALOGWATCHDOG_ALL_INJEC                                                                                   \
  (ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to injected group all channels                  */
#define ADC_ANALOGWATCHDOG_ALL_REGINJEC                                                                                \
  (ADC_CFGR_AWD1EN | ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to regular and injected groups all channels     */
/**
 * @}
 */
...
#define ADC_OVERSAMPLING_RATIO_2                                                                                       \
  (LL_ADC_OVS_RATIO_2) /*!< ADC oversampling ratio of 2 (2 ADC conversions are performed, sum of these conversions     \
                          data is computed to result as the ADC oversampling conversion data (before potential shift)  \
                        */
#define ADC_OVERSAMPLING_RATIO_4                                                                                       \
  (LL_ADC_OVS_RATIO_4) /*!< ADC oversampling ratio of 4 (4 ADC conversions are performed, sum of these conversions     \
                          data is computed to result as the ADC oversampling conversion data (before potential shift)  \
                        */
#define ADC_OVERSAMPLING_RATIO_8                                                                                       \
  (LL_ADC_OVS_RATIO_8) /*!< ADC oversampling ratio of 8 (8 ADC conversions are performed, sum of these conversions     \
                          data is computed to result as the ADC oversampling conversion data (before potential shift)  \
                        */
#define ADC_OVERSAMPLING_RATIO_16                                                                                      \
  (LL_ADC_OVS_RATIO_16) /*!< ADC oversampling ratio of 16 (16 ADC conversions are performed, sum of these conversions  \
                           data is computed to result as the ADC oversampling conversion data (before potential shift) \
                         */
#define ADC_OVERSAMPLING_RATIO_32                                                                                      \
  (LL_ADC_OVS_RATIO_32) /*!< ADC oversampling ratio of 32 (32 ADC conversions are performed, sum of these conversions  \
                           data is computed to result as the ADC oversampling conversion data (before potential shift) \
                         */
#define ADC_OVERSAMPLING_RATIO_64                                                                                      \
  (LL_ADC_OVS_RATIO_64) /*!< ADC oversampling ratio of 64 (64 ADC conversions are performed, sum of these conversions  \
                           data is computed to result as the ADC oversampling conversion data (before potential shift) \
                         */
#define ADC_OVERSAMPLING_RATIO_128                                                                                     \
  (LL_ADC_OVS_RATIO_128) /*!< ADC oversampling ratio of 128 (128 ADC conversions are performed, sum of these           \
                            conversions data is computed to result as the ADC oversampling conversion data (before     \
                            potential shift) */
#define ADC_OVERSAMPLING_RATIO_256                                                                                     \
  (LL_ADC_OVS_RATIO_256) /*!< ADC oversampling ratio of 256 (256 ADC conversions are performed, sum of these           \
                            conversions data is computed to result as the ADC oversampling conversion data (before     \
                            potential shift) */
/**
 * @}
...
#define ADC_RIGHTBITSHIFT_NONE                                                                                         \
  (LL_ADC_OVS_SHIFT_NONE) /*!< ADC oversampling no shift (sum of the ADC conversions data is not divided to result as  \
                             the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_1                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_1) /*!< ADC oversampling shift of 1 (sum of the ADC conversions data is divided by 2 to      \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_2                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_2) /*!< ADC oversampling shift of 2 (sum of the ADC conversions data is divided by 4 to      \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_3                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_3) /*!< ADC oversampling shift of 3 (sum of the ADC conversions data is divided by 8 to      \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_4                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_4) /*!< ADC oversampling shift of 4 (sum of the ADC conversions data is divided by 16 to     \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_5                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_5) /*!< ADC oversampling shift of 5 (sum of the ADC conversions data is divided by 32 to     \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_6                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_6) /*!< ADC oversampling shift of 6 (sum of the ADC conversions data is divided by 64 to     \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_7                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_7) /*!< ADC oversampling shift of 7 (sum of the ADC conversions data is divided by 128 to    \
                                result as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_8                                                                                            \
  (LL_ADC_OVS_SHIFT_RIGHT_8) /*!< ADC oversampling shift of 8 (sum of the ADC conversions data is divided by 256 to    \
                                result as the ADC oversampling conversion data) */
/**
 * @}
 */
...
#define ADC_TRIGGEREDMODE_SINGLE_TRIGGER                                                                               \
  (LL_ADC_OVS_REG_CONT) /*!< ADC oversampling discontinuous mode: continuous mode (all conversions of oversampling     \
                           ratio are done from 1 trigger) */
#define ADC_TRIGGEREDMODE_MULTI_TRIGGER                                                                                \
  (LL_ADC_OVS_REG_DISCONT) /*!< ADC oversampling discontinuous mode: discontinuous mode (each conversion of            \
...
#define ADC_REGOVERSAMPLING_CONTINUED_MODE                                                                             \
  (LL_ADC_OVS_GRP_REGULAR_CONTINUED) /*!< Oversampling buffer maintained during injection sequence */
#define ADC_REGOVERSAMPLING_RESUMED_MODE                                                                               \
  (LL_ADC_OVS_GRP_REGULAR_RESUMED) /*!< Oversampling buffer zeroed during injection sequence     */
/**
 * @}
 */
...
#define ADC_AWD1_EVENT                                                                                                 \
  (ADC_FLAG_AWD1) /*!< ADC Analog watchdog 1 event (main analog watchdog, present on all STM32 series) */
#define ADC_AWD2_EVENT                                                                                                 \
  (ADC_FLAG_AWD2) /*!< ADC Analog watchdog 2 event (additional analog watchdog, not present on all STM32 series) */
#define ADC_AWD3_EVENT                                                                                                 \
  (ADC_FLAG_AWD3) /*!< ADC Analog watchdog 3 event (additional analog watchdog, not present on all STM32 series) */
...
#define ADC_AWD_EVENT                                                                                                  \
  ADC_AWD1_EVENT /*!< ADC Analog watchdog 1 event: Naming for compatibility with other STM32 devices having only one   \
                    analog watchdog */
...
#define ADC_IT_AWD                                                                                                     \
  ADC_IT_AWD1 /*!< ADC Analog watchdog 1 interrupt source: naming for compatibility with other STM32 devices having    \
                 only one analog watchdog */
...
#define ADC_FLAG_AWD                                                                                                   \
  ADC_FLAG_AWD1 /*!< ADC Analog watchdog 1 flag: Naming for compatibility with other STM32 devices having only one     \
                   analog watchdog */

#define ADC_FLAG_ALL                                                                                                   \
  (ADC_FLAG_RDY | ADC_FLAG_EOSMP | ADC_FLAG_EOC | ADC_FLAG_EOS | ADC_FLAG_JEOC | ADC_FLAG_JEOS | ADC_FLAG_OVR |        \
   ADC_FLAG_AWD1 | ADC_FLAG_AWD2 | ADC_FLAG_AWD3 | ADC_FLAG_JQOVF) /*!< ADC all flags */

/* Combination of all post-conversion flags bits: EOC/EOS, JEOC/JEOS, OVR, AWDx, JQOVF */
#define ADC_FLAG_POSTCONV_ALL                                                                                          \
  (ADC_FLAG_EOC | ADC_FLAG_EOS | ADC_FLAG_JEOC | ADC_FLAG_JEOS | ADC_FLAG_OVR | ADC_FLAG_AWD1 | ADC_FLAG_AWD2 |        \
   ADC_FLAG_AWD3 | ADC_FLAG_JQOVF) /*!< ADC post-conversion all flags */
 ...
 * @retval SET (__LENGTH__ is within the maximum number of possible programmable regular conversions) or RESET
 * (__LENGTH__ is null or too large)
 */
 ...
 * @retval SET (NUMBER is within the maximum number of regular conversions in discontinuous mode) or RESET (NUMBER is
 * null or too large)
 */
...
#define IS_ADC_CLOCKPRESCALER(__ADC_CLOCK__)                                                                           \
  (((__ADC_CLOCK__) == ADC_CLOCK_SYNC_PCLK_DIV1) || ((__ADC_CLOCK__) == ADC_CLOCK_SYNC_PCLK_DIV2) ||                   \
   ((__ADC_CLOCK__) == ADC_CLOCK_SYNC_PCLK_DIV4) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV1) ||                       \
   ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV2) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV4) ||                           \
   ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV6) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV8) ||                           \
   ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV10) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV12) ||                         \
   ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV16) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV32) ||                         \
   ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV64) || ((__ADC_CLOCK__) == ADC_CLOCK_ASYNC_DIV128) ||                        \
...
#define IS_ADC_RESOLUTION(__RESOLUTION__)                                                                              \
  (((__RESOLUTION__) == ADC_RESOLUTION_12B) || ((__RESOLUTION__) == ADC_RESOLUTION_10B) ||                             \
...
#define IS_ADC_SAMPLE_TIME(__TIME__)                                                                                   \
  (((__TIME__) == ADC_SAMPLETIME_2CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_3CYCLES_5) ||                             \
   ((__TIME__) == ADC_SAMPLETIME_6CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_12CYCLES_5) ||                            \
   ((__TIME__) == ADC_SAMPLETIME_24CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_47CYCLES_5) ||                           \
   ((__TIME__) == ADC_SAMPLETIME_92CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_247CYCLES_5) ||                          \
   ((__TIME__) == ADC_SAMPLETIME_640CYCLES_5))
#else
#define IS_ADC_SAMPLE_TIME(__TIME__)                                                                                   \
  (((__TIME__) == ADC_SAMPLETIME_2CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_6CYCLES_5) ||                             \
   ((__TIME__) == ADC_SAMPLETIME_12CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_24CYCLES_5) ||                           \
   ((__TIME__) == ADC_SAMPLETIME_47CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_92CYCLES_5) ||                           \
   ((__TIME__) == ADC_SAMPLETIME_247CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_640CYCLES_5))
#endif /* ADC_SMPR1_SMPPLUS */
 ...
 * @retval Temperature (unit: degree Celsius)
 */
#define __HAL_ADC_CALC_TEMPERATURE_TYP_PARAMS(__TEMPSENSOR_TYP_AVGSLOPE__, __TEMPSENSOR_TYP_CALX_V__,                  \
                                              __TEMPSENSOR_CALX_TEMP__, __VREFANALOG_VOLTAGE__,                        \
                                              __TEMPSENSOR_ADC_DATA__, __ADC_RESOLUTION__)                             \
  __LL_ADC_CALC_TEMPERATURE_TYP_PARAMS((__TEMPSENSOR_TYP_AVGSLOPE__), (__TEMPSENSOR_TYP_CALX_V__),                     \
                                       (__TEMPSENSOR_CALX_TEMP__), (__VREFANALOG_VOLTAGE__),                           \
                                       (__TEMPSENSOR_ADC_DATA__), (__ADC_RESOLUTION__))
