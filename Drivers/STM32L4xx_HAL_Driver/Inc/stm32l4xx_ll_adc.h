...
#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS                                                                              \
  (12UL) /* Value equivalent to bitfield "ADC_SQR1_SQ2" position in register                                           \
          */
#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS                                                                              \
  (18UL) /* Value equivalent to bitfield "ADC_SQR1_SQ3" position in register                                           \
          */
#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS                                                                              \
  (24UL)                                        /* Value equivalent to bitfield "ADC_SQR1_SQ4" position in register    \
                                                 */
...
#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS                                                                              \
  (12UL) /* Value equivalent to bitfield "ADC_SQR2_SQ7" position in register                                           \
          */
#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS                                                                              \
  (18UL) /* Value equivalent to bitfield "ADC_SQR2_SQ8" position in register                                           \
          */
#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS                                                                              \
  (24UL) /* Value equivalent to bitfield "ADC_SQR2_SQ9" position in register                                           \
          */
#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS                                                                             \
  (0UL) /* Value equivalent to bitfield "ADC_SQR3_SQ10" position in register                                           \
         */
#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS                                                                             \
  (6UL) /* Value equivalent to bitfield "ADC_SQR3_SQ11" position in register                                           \
         */
#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS                                                                             \
  (12UL) /* Value equivalent to bitfield "ADC_SQR3_SQ12" position in register */
#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS                                                                             \
  (18UL) /* Value equivalent to bitfield "ADC_SQR3_SQ13" position in register */
#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS                                                                             \
  (24UL) /* Value equivalent to bitfield "ADC_SQR3_SQ14" position in register */
#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS                                                                             \
  (0UL) /* Value equivalent to bitfield "ADC_SQR4_SQ15" position in register                                           \
         */
#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS                                                                             \
  (6UL) /* Value equivalent to bitfield "ADC_SQR4_SQ16" position in register                                           \
         */
...
#define ADC_INJ_RANK_1_JSQR_BITOFFSET_POS                                                                              \
  (8UL) /* Value equivalent to bitfield "ADC_JSQR_JSQ1" position in register                                           \
         */
#define ADC_INJ_RANK_2_JSQR_BITOFFSET_POS                                                                              \
  (14UL) /* Value equivalent to bitfield "ADC_JSQR_JSQ2" position in register                                          \
          */
#define ADC_INJ_RANK_3_JSQR_BITOFFSET_POS                                                                              \
  (20UL) /* Value equivalent to bitfield "ADC_JSQR_JSQ3" position in register                                          \
          */
#define ADC_INJ_RANK_4_JSQR_BITOFFSET_POS                                                                              \
  (26UL) /* Value equivalent to bitfield "ADC_JSQR_JSQ4" position in register                                          \
          */
...
#define ADC_REG_TRIG_EXT_EDGE_DEFAULT                                                                                  \
  (ADC_CFGR_EXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility with some ADC on other      \
...
#define ADC_REG_TRIG_SOURCE_MASK                                                                                       \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CFGR_EXTSEL) << (4U * 0UL)) | ((ADC_CFGR_EXTSEL) << (4U * 1UL)) |                  \
   ((ADC_CFGR_EXTSEL) << (4U * 2UL)) | ((ADC_CFGR_EXTSEL) << (4U * 3UL)))

/* Mask containing trigger edge masks for each of possible                    */
/* trigger edge selection duplicated with shifts [0; 4; 8; 12]                */
/* corresponding to {SW start; ext trigger; ext trigger; ext trigger}.        */
#define ADC_REG_TRIG_EDGE_MASK                                                                                         \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CFGR_EXTEN) << (4U * 0UL)) | ((ADC_REG_TRIG_EXT_EDGE_DEFAULT) << (4U * 1UL)) |     \
   ((ADC_REG_TRIG_EXT_EDGE_DEFAULT) << (4U * 2UL)) | ((ADC_REG_TRIG_EXT_EDGE_DEFAULT) << (4U * 3UL)))

/* Definition of ADC group regular trigger bits information.                  */
#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS                                                                              \
  (6UL) /* Value equivalent to bitfield "ADC_CFGR_EXTSEL" position in register */
#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS                                                                               \
  (10UL) /* Value equivalent to bitfield "ADC_CFGR_EXTEN" position in register                                         \
          */
...
#define ADC_INJ_TRIG_EXT_EDGE_DEFAULT                                                                                  \
  (ADC_JSQR_JEXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility with some ADC on other     \
                         STM32 families having this setting set by HW default value) */
...
#define ADC_INJ_TRIG_EDGE_MASK                                                                                         \
  (((LL_ADC_INJ_TRIG_SOFTWARE & ADC_JSQR_JEXTEN) << (4U * 0UL)) | ((ADC_INJ_TRIG_EXT_EDGE_DEFAULT) << (4U * 1UL)) |    \
   ((ADC_INJ_TRIG_EXT_EDGE_DEFAULT) << (4U * 2UL)) | ((ADC_INJ_TRIG_EXT_EDGE_DEFAULT) << (4U * 3UL)))

/* Definition of ADC group injected trigger bits information.                 */
#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS                                                                              \
  (2UL) /* Value equivalent to bitfield "ADC_JSQR_JEXTSEL" position in register */
#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS                                                                               \
  (6UL) /* Value equivalent to bitfield "ADC_JSQR_JEXTEN" position in register                                         \
         */
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS                                                                            \
  (26UL) /* Value equivalent to bitfield "ADC_CHANNEL_ID_NUMBER_MASK" position in register */
...
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                                                                   \
  (0x00080000UL) /* Marker of internal channel for other ADC instances, in case of different ADC internal channels     \
...
#define ADC_CHANNEL_SMPx_BITOFFSET_POS                                                                                 \
  (20UL) /* Value equivalent to bitfield "ADC_CHANNEL_SMPx_BITOFFSET_MASK" position in register */
...
#define ADC_CHANNEL_0_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((0UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR1_SMP0" position in register */
#define ADC_CHANNEL_1_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((3UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR1_SMP1" position in register */
#define ADC_CHANNEL_2_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((6UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR1_SMP2" position in register */
#define ADC_CHANNEL_3_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((9UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR1_SMP3" position in register */
#define ADC_CHANNEL_4_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((12UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP4" position in register */
#define ADC_CHANNEL_5_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((15UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP5" position in register */
#define ADC_CHANNEL_6_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((18UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP6" position in register */
#define ADC_CHANNEL_7_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((21UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP7" position in register */
#define ADC_CHANNEL_8_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((24UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP8" position in register */
#define ADC_CHANNEL_9_SMP                                                                                              \
  (ADC_SMPR1_REGOFFSET | ((27UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR1_SMP9" position in register */
#define ADC_CHANNEL_10_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((0UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR2_SMP10" position in register */
#define ADC_CHANNEL_11_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((3UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR2_SMP11" position in register */
#define ADC_CHANNEL_12_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((6UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR2_SMP12" position in register */
#define ADC_CHANNEL_13_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((9UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield         \
                                                                       "ADC_SMPR2_SMP13" position in register */
#define ADC_CHANNEL_14_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((12UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR2_SMP14" position in register */
#define ADC_CHANNEL_15_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((15UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR2_SMP15" position in register */
#define ADC_CHANNEL_16_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((18UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR2_SMP16" position in register */
#define ADC_CHANNEL_17_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((21UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR2_SMP17" position in register */
#define ADC_CHANNEL_18_SMP                                                                                             \
  (ADC_SMPR2_REGOFFSET | ((24UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield        \
                                                                        "ADC_SMPR2_SMP18" position in register */
...
#define ADC_SINGLEDIFF_CHANNEL_SHIFT_MASK                                                                              \
  (ADC_CALFACT_CALFACT_S_4 | ADC_CALFACT_CALFACT_S_3) /* Bits chosen to perform of shift when single mode is selected, \
                                                         shift value out of channels bits range. */
#define ADC_SINGLEDIFF_CALIB_F_BIT_D_MASK                                                                              \
  (0x00010000UL) /* Selection of 1 bit to discriminate differential mode: mask of bit */
#define ADC_SINGLEDIFF_CALIB_F_BIT_D_POS                                                                               \
  (16UL) /* Selection of 1 bit to discriminate differential mode: position of bit */
#define ADC_SINGLEDIFF_CALIB_F_BIT_D_SHIFT4                                                                            \
  (ADC_SINGLEDIFF_CALIB_F_BIT_D_POS - 4UL) /* Shift of bit ADC_SINGLEDIFF_CALIB_F_BIT_D to position to perform a shift \
                                              of 4 ranks */
...
#define ADC_AWD_TRX_REGOFFSET_POS                                                                                      \
  (ADC_AWD_CRX_REGOFFSET_POS)                    /* Position of bits ADC_SQRx_REGOFFSET in ADC_AWD_TRX_REGOFFSET_MASK */
...
#define ADC_AWD_TRX_BIT_HIGH_SHIFT4                                                                                    \
  (ADC_AWD_TRX_BIT_HIGH_POS - 4UL) /* Shift of bit ADC_AWD_TRX_BIT_HIGH to position to perform a shift of 4 ranks */
...
#define ADC_CFGR_AWD1SGL_BITOFFSET_POS                                                                                 \
  (22UL)                                     /* Value equivalent to bitfield "ADC_CFGR_AWD1SGL" position in register   \
                                              */
#define ADC_CFGR_AWD1EN_BITOFFSET_POS (23UL) /* Value equivalent to bitfield "ADC_CFGR_AWD1EN" position in register */
#define ADC_CFGR_JAWD1EN_BITOFFSET_POS                                                                                 \
  (24UL)                                 /* Value equivalent to bitfield "ADC_CFGR_JAWD1EN" position in register       \
                                          */
...
#define ADC_CR_BITS_PROPERTY_RS                                                                                        \
  (ADC_CR_ADCAL | ADC_CR_JADSTP | ADC_CR_ADSTP | ADC_CR_JADSTART | ADC_CR_ADSTART | ADC_CR_ADDIS |                     \
   ADC_CR_ADEN) /* ADC register CR bits with HW property "rs": Software can read as well as set this bit. Writing '0'  \
                   has no effect on the bit value. */

/* ADC internal channels related definitions */
/* Internal voltage reference VrefInt */
#define VREFINT_CAL_ADDR                                                                                               \
  ((uint16_t*)(0x1FFF75AAUL)) /* Internal voltage reference, address of parameter VREFINT_CAL: VrefInt ADC raw data    \
                                 acquired at temperature 30 DegC (tolerance: +-5 DegC), Vref+ = 3.0 V (tolerance: +-10 \
                                 mV). */
#define VREFINT_CAL_VREF                                                                                               \
  (3000UL) /* Analog voltage reference (Vref+) value with which temperature sensor has been calibrated in production   \
              (tolerance: +-10 mV) (unit: mV). */
/* Temperature sensor */
#define TEMPSENSOR_CAL1_ADDR                                                                                           \
  ((uint16_t*)(0x1FFF75A8UL)) /* Internal temperature sensor, address of parameter TS_CAL1: On STM32L4, temperature    \
                                 sensor ADC raw data acquired at temperature  30 DegC (tolerance: +-5 DegC), Vref+     \
                                 = 3.0 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                                                           \
  ((uint16_t*)(0x1FFF75CAUL)) /* Internal temperature sensor, address of parameter TS_CAL2: On STM32L4, temperature    \
                                 sensor ADC raw data acquired at temperature defined by TEMPSENSOR_CAL2_TEMP           \
                                 (tolerance: +-5 DegC), Vref+ = 3.0 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL1_TEMP                                                                                           \
  ((int32_t)30L) /* Internal temperature sensor, temperature at which temperature sensor has been calibrated in        \
                    production for data into TEMPSENSOR_CAL1_ADDR (tolerance: +-5 DegC) (unit: DegC). */
#if defined(STM32L471xx) || defined(STM32L475xx) || defined(STM32L476xx) || defined(STM32L485xx) || defined(STM32L486xx)
#define TEMPSENSOR_CAL2_TEMP                                                                                           \
  (110L) /* Internal temperature sensor, temperature at which temperature sensor has been calibrated in production for \
            data into TEMPSENSOR_CAL2_ADDR (tolerance: +-5 DegC) (unit: DegC). */
#else
#define TEMPSENSOR_CAL2_TEMP                                                                                           \
  (130L) /* Internal temperature sensor, temperature at which temperature sensor has been calibrated in production for \
            data into TEMPSENSOR_CAL2_ADDR (tolerance: +-5 DegC) (unit: DegC). */
#endif /* defined (STM32L471xx) || defined (STM32L475xx) || defined (STM32L476xx) || defined (STM32L485xx) || defined  \
          (STM32L486xx) */
#define TEMPSENSOR_CAL_VREFANALOG                                                                                      \
  (3000UL) /* Analog voltage reference (Vref+) voltage with which temperature sensor has been calibrated in production \
              (+-10 mV) (unit: mV). */
...
typedef struct
{
  ...
  uint32_t Multimode; /*!< Set ADC multimode configuration to operate in independent mode or multimode (for devices with
...
typedef struct
{
  uint32_t TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW start) or from external
                             peripheral (timer event, external interrupt line). This parameter can be a value of @ref
                             ADC_LL_EC_REG_TRIGGER_SOURCE
                               @note On this STM32 series, setting trigger source to external trigger also set trigger
                             ...
                             edge, use function @ref LL_ADC_REG_SetTriggerEdge().
  ...
  uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode: sequence subdivided and scan
                                conversions interrupted every selected number of ranks. This parameter can be a value of
                                @ref ADC_LL_EC_REG_SEQ_DISCONT_MODE
  ...
  uint32_t ContinuousMode; /*!< Set ADC continuous conversion mode on ADC group regular, whether ADC conversions are
                              ...
                              first trigger, following conversions launched successively automatically). This parameter
                              can be a value of @ref ADC_LL_EC_REG_CONTINUOUS_MODE Note: It is not possible to enable
                              both ADC group regular continuous mode and discontinuous mode.
...
typedef struct
{
  uint32_t TriggerSource; /*!< Set ADC group injected conversion trigger source: internal (SW start) or from external
                             ...
                             polarity to rising edge (default setting for compatibility with some ADC on other STM32
                             families having this setting set by HW default value). In case of need to modify trigger
                             edge, use function @ref LL_ADC_INJ_SetTriggerEdge().
  ...
  uint32_t SequencerDiscont; /*!< Set ADC group injected sequencer discontinuous mode: sequence subdivided and scan
                                conversions interrupted every selected number of ranks. This parameter can be a value of
                                @ref ADC_LL_EC_INJ_SEQ_DISCONT_MODE
  ...
  uint32_t TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC group regular.
                          ...
                          Note: This parameter must be set to set to independent trigger if injected trigger source is
...
#define LL_ADC_FLAG_EOC_MST                                                                                            \
  ADC_CSR_EOC_MST /*!< ADC flag ADC multimode master group regular end of unitary conversion */
#define LL_ADC_FLAG_EOC_SLV                                                                                            \
  ADC_CSR_EOC_SLV /*!< ADC flag ADC multimode slave group regular end of unitary conversion                            \
                   */
#define LL_ADC_FLAG_EOS_MST                                                                                            \
  ADC_CSR_EOS_MST /*!< ADC flag ADC multimode master group regular end of sequence conversions */
#define LL_ADC_FLAG_EOS_SLV                                                                                            \
  ADC_CSR_EOS_SLV /*!< ADC flag ADC multimode slave group regular end of sequence conversions */
...
#define LL_ADC_FLAG_EOSMP_MST                                                                                          \
  ADC_CSR_EOSMP_MST /*!< ADC flag ADC multimode master group regular end of sampling phase */
#define LL_ADC_FLAG_EOSMP_SLV                                                                                          \
  ADC_CSR_EOSMP_SLV /*!< ADC flag ADC multimode slave group regular end of sampling phase                              \
                     */
#define LL_ADC_FLAG_JEOC_MST                                                                                           \
  ADC_CSR_JEOC_MST /*!< ADC flag ADC multimode master group injected end of unitary conversion */
#define LL_ADC_FLAG_JEOC_SLV                                                                                           \
  ADC_CSR_JEOC_SLV /*!< ADC flag ADC multimode slave group injected end of unitary conversion */
#define LL_ADC_FLAG_JEOS_MST                                                                                           \
  ADC_CSR_JEOS_MST /*!< ADC flag ADC multimode master group injected end of sequence conversions */
#define LL_ADC_FLAG_JEOS_SLV                                                                                           \
  ADC_CSR_JEOS_SLV /*!< ADC flag ADC multimode slave group injected end of sequence conversions */
#define LL_ADC_FLAG_JQOVF_MST                                                                                          \
  ADC_CSR_JQOVF_MST /*!< ADC flag ADC multimode master group injected contexts queue overflow */
#define LL_ADC_FLAG_JQOVF_SLV                                                                                          \
  ADC_CSR_JQOVF_SLV /*!< ADC flag ADC multimode slave group injected contexts queue overflow */
#define LL_ADC_FLAG_AWD1_MST                                                                                           \
  ADC_CSR_AWD1_MST                            /*!< ADC flag ADC multimode master analog watchdog 1 of the ADC master   \
                                               */
...
#define LL_ADC_FLAG_AWD2_MST                                                                                           \
  ADC_CSR_AWD2_MST                            /*!< ADC flag ADC multimode master analog watchdog 2 of the ADC master   \
                                               */
...
#define LL_ADC_FLAG_AWD3_MST                                                                                           \
  ADC_CSR_AWD3_MST                            /*!< ADC flag ADC multimode master analog watchdog 3 of the ADC master   \
                                               */
...
#define LL_ADC_DMA_REG_REGULAR_DATA                                                                                    \
  (0x00000000UL) /* ADC group regular conversion data register (corresponding to register DR) to be used with ADC      \
...
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                                                              \
  (0x00000001UL) /* ADC group regular conversion data register (corresponding to register CDR) to be used with ADC     \
...
#define LL_ADC_CLOCK_SYNC_PCLK_DIV1                                                                                    \
  (ADC_CCR_CKMODE_0) /*!< ADC synchronous clock derived from AHB clock without prescaler */
#define LL_ADC_CLOCK_SYNC_PCLK_DIV2                                                                                    \
  (ADC_CCR_CKMODE_1) /*!< ADC synchronous clock derived from AHB clock with prescaler division by 2 */
#define LL_ADC_CLOCK_SYNC_PCLK_DIV4                                                                                    \
  (ADC_CCR_CKMODE_1 | ADC_CCR_CKMODE_0) /*!< ADC synchronous clock derived from AHB clock with prescaler division by 4 \
                                         */
...
#define LL_ADC_CLOCK_ASYNC_DIV6                                                                                        \
  (ADC_CCR_PRESC_1 | ADC_CCR_PRESC_0)             /*!< ADC asynchronous clock with prescaler division by 6   */
...
#define LL_ADC_CLOCK_ASYNC_DIV10                                                                                       \
  (ADC_CCR_PRESC_2 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 10  */
#define LL_ADC_CLOCK_ASYNC_DIV12                                                                                       \
  (ADC_CCR_PRESC_2 | ADC_CCR_PRESC_1) /*!< ADC asynchronous clock with prescaler division by 12  */
#define LL_ADC_CLOCK_ASYNC_DIV16                                                                                       \
  (ADC_CCR_PRESC_2 | ADC_CCR_PRESC_1 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 16  */
...
#define LL_ADC_CLOCK_ASYNC_DIV64                                                                                       \
  (ADC_CCR_PRESC_3 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 64  */
#define LL_ADC_CLOCK_ASYNC_DIV128                                                                                      \
  (ADC_CCR_PRESC_3 | ADC_CCR_PRESC_1) /*!< ADC asynchronous clock with prescaler division by 128 */
#define LL_ADC_CLOCK_ASYNC_DIV256                                                                                      \
  (ADC_CCR_PRESC_3 | ADC_CCR_PRESC_1 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 256 */
/**
 * @}
 */
...
#define LL_ADC_DATA_ALIGN_RIGHT                                                                                        \
  (0x00000000UL) /*!< ADC conversion data alignment: right aligned (alignment on data register LSB bit 0)*/
#define LL_ADC_DATA_ALIGN_LEFT                                                                                         \
  (ADC_CFGR_ALIGN) /*!< ADC conversion data alignment: left aligned (alignment on data register MSB bit 15)*/
/**
 * @}
 */
...
#define LL_ADC_LP_AUTOWAIT                                                                                             \
  (ADC_CFGR_AUTDLY) /*!< ADC low power mode auto delay: Dynamic low power mode, ADC conversions are performed only     \
                       when necessary (when previous ADC conversion data is read). See description with function @ref  \
                       LL_ADC_SetLowPowerMode(). */
/**
 * @}
 */
...
#define LL_ADC_OFFSET_1                                                                                                \
  ADC_OFR1_REGOFFSET /*!< ADC offset number 1: ADC channel and offset level to which the offset programmed will be     \
                        applied (independently of channel mapped on ADC group regular or group injected) */
#define LL_ADC_OFFSET_2                                                                                                \
  ADC_OFR2_REGOFFSET /*!< ADC offset number 2: ADC channel and offset level to which the offset programmed will be     \
                        applied (independently of channel mapped on ADC group regular or group injected) */
#define LL_ADC_OFFSET_3                                                                                                \
  ADC_OFR3_REGOFFSET /*!< ADC offset number 3: ADC channel and offset level to which the offset programmed will be     \
                        applied (independently of channel mapped on ADC group regular or group injected) */
#define LL_ADC_OFFSET_4                                                                                                \
  ADC_OFR4_REGOFFSET /*!< ADC offset number 4: ADC channel and offset level to which the offset programmed will be     \
                        applied (independently of channel mapped on ADC group regular or group injected) */
/**
 * @}
 */
...
#define LL_ADC_OFFSET_DISABLE                                                                                          \
  (0x00000000UL) /*!< ADC offset disabled (among ADC selected offset number 1, 2, 3 or 4)                              \
                  */
#define LL_ADC_OFFSET_ENABLE                                                                                           \
  (ADC_OFR1_OFFSET1_EN) /*!< ADC offset enabled (among ADC selected offset number 1, 2, 3 or 4) */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_0                                                                                               \
  (ADC_CHANNEL_0_NUMBER | ADC_CHANNEL_0_SMP | ADC_CHANNEL_0_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN0  */
#define LL_ADC_CHANNEL_1                                                                                               \
  (ADC_CHANNEL_1_NUMBER | ADC_CHANNEL_1_SMP | ADC_CHANNEL_1_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN1  */
#define LL_ADC_CHANNEL_2                                                                                               \
  (ADC_CHANNEL_2_NUMBER | ADC_CHANNEL_2_SMP | ADC_CHANNEL_2_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN2  */
#define LL_ADC_CHANNEL_3                                                                                               \
  (ADC_CHANNEL_3_NUMBER | ADC_CHANNEL_3_SMP | ADC_CHANNEL_3_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN3  */
#define LL_ADC_CHANNEL_4                                                                                               \
  (ADC_CHANNEL_4_NUMBER | ADC_CHANNEL_4_SMP | ADC_CHANNEL_4_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN4  */
#define LL_ADC_CHANNEL_5                                                                                               \
  (ADC_CHANNEL_5_NUMBER | ADC_CHANNEL_5_SMP | ADC_CHANNEL_5_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN5  */
#define LL_ADC_CHANNEL_6                                                                                               \
  (ADC_CHANNEL_6_NUMBER | ADC_CHANNEL_6_SMP | ADC_CHANNEL_6_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN6  */
#define LL_ADC_CHANNEL_7                                                                                               \
  (ADC_CHANNEL_7_NUMBER | ADC_CHANNEL_7_SMP | ADC_CHANNEL_7_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN7  */
#define LL_ADC_CHANNEL_8                                                                                               \
  (ADC_CHANNEL_8_NUMBER | ADC_CHANNEL_8_SMP | ADC_CHANNEL_8_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN8  */
#define LL_ADC_CHANNEL_9                                                                                               \
  (ADC_CHANNEL_9_NUMBER | ADC_CHANNEL_9_SMP | ADC_CHANNEL_9_BITFIELD) /*!< ADC external channel (channel connected to  \
                                                                         GPIO pin) ADCx_IN9  */
#define LL_ADC_CHANNEL_10                                                                                              \
  (ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP | ADC_CHANNEL_10_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN10 */
#define LL_ADC_CHANNEL_11                                                                                              \
  (ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP | ADC_CHANNEL_11_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN11 */
#define LL_ADC_CHANNEL_12                                                                                              \
  (ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP | ADC_CHANNEL_12_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN12 */
#define LL_ADC_CHANNEL_13                                                                                              \
  (ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP | ADC_CHANNEL_13_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN13 */
#define LL_ADC_CHANNEL_14                                                                                              \
  (ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP | ADC_CHANNEL_14_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN14 */
#define LL_ADC_CHANNEL_15                                                                                              \
  (ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP | ADC_CHANNEL_15_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN15 */
#define LL_ADC_CHANNEL_16                                                                                              \
  (ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP | ADC_CHANNEL_16_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN16 */
#define LL_ADC_CHANNEL_17                                                                                              \
  (ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP | ADC_CHANNEL_17_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN17 */
#define LL_ADC_CHANNEL_18                                                                                              \
  (ADC_CHANNEL_18_NUMBER | ADC_CHANNEL_18_SMP | ADC_CHANNEL_18_BITFIELD) /*!< ADC external channel (channel connected  \
                                                                            to GPIO pin) ADCx_IN18 */
#define LL_ADC_CHANNEL_VREFINT                                                                                         \
  (LL_ADC_CHANNEL_0 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal voltage     \
                                                     reference. On STM32L4, ADC channel available only on ADC          \
                                                     instance: ADC1. */
#define LL_ADC_CHANNEL_TEMPSENSOR                                                                                      \
  (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Temperature sensor. On       \
                                                      STM32L4, ADC channel available only on ADC instances: ADC1,      \
                                                      ADC3. */
#define LL_ADC_CHANNEL_VBAT                                                                                            \
  (LL_ADC_CHANNEL_18 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3: Vbat voltage through \
                                                      a divider ladder of factor 1/3 to have Vbat always below Vdda.   \
                                                      On STM32L4, ADC channel available only on ADC instances: ADC1,   \
                                                      ADC3. */
#if defined(ADC1) && !defined(ADC2)
#define LL_ADC_CHANNEL_DAC1CH1                                                                                         \
  (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH |                                                                    \
   ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel connected to DAC1 channel 1, channel specific to ADC1. This \
                                    channel is shared with ADC internal channel connected to temperature sensor,       \
                                    selection is done using function @ref LL_ADC_SetCommonPathInternalCh(). */
#define LL_ADC_CHANNEL_DAC1CH2                                                                                         \
  (LL_ADC_CHANNEL_18 | ADC_CHANNEL_ID_INTERNAL_CH |                                                                    \
   ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel connected to DAC1 channel 2, channel specific to ADC1. This \
                                    channel is shared with ADC internal channel connected to Vbat, selection is done   \
                                    using function @ref LL_ADC_SetCommonPathInternalCh(). */
#elif defined(ADC2)
#define LL_ADC_CHANNEL_DAC1CH1_ADC2                                                                                    \
  (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH |                                                                    \
   ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel connected to DAC1 channel 1, channel specific to ADC2 */
#define LL_ADC_CHANNEL_DAC1CH2_ADC2                                                                                    \
  (LL_ADC_CHANNEL_18 | ADC_CHANNEL_ID_INTERNAL_CH |                                                                    \
   ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel connected to DAC1 channel 2, channel specific to ADC2 */
#if defined(ADC3)
#define LL_ADC_CHANNEL_DAC1CH1_ADC3                                                                                    \
  (LL_ADC_CHANNEL_14 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1 channel 1, channel      \
                                                      specific to ADC3 */
#define LL_ADC_CHANNEL_DAC1CH2_ADC3                                                                                    \
  (LL_ADC_CHANNEL_15 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1 channel 2, channel      \
                                                      specific to ADC3 */
#endif                                             /* ADC3 */
#endif                                             /* ADC1 && !ADC2 */
/**
...
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_0 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM1 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                                                                 \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM1 TRGO2.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                                                                   \
  (ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM1 channel 1   \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                                                                   \
  (ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external          \
                                                         peripheral: TIM1 channel 2 event (capture compare: input      \
                                                         capture or output capture). Trigger edge set to rising edge   \
                                                         (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                                                                   \
  (ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external          \
                                                         peripheral: TIM1 channel 3 event (capture compare: input      \
                                                         capture or output capture). Trigger edge set to rising edge   \
                                                         (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM2 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                                                   \
  (ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM2 channel 2   \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_2 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external          \
                                                         peripheral: TIM3 TRGO. Trigger edge set to rising edge        \
                                                         (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_CH4                                                                                   \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM3 channel 4   \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM4 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                                                                   \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM4 channel 4   \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM6_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM6 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                                                                  \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM8 TRGO.       \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO2                                                                                 \
  (ADC_CFGR_EXTSEL_3 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external          \
                                                         peripheral: TIM8 TRGO2. Trigger edge set to rising edge       \
                                                         (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO                                                                                 \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: TIM15 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                                                \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |                                                                             \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from external peripheral: external         \
...
#define LL_ADC_REG_TRIG_EXT_RISING                                                                                     \
  (ADC_CFGR_EXTEN_0) /*!< ADC group regular conversion trigger polarity set to rising edge */
#define LL_ADC_REG_TRIG_EXT_FALLING                                                                                    \
  (ADC_CFGR_EXTEN_1) /*!< ADC group regular conversion trigger polarity set to falling edge */
#define LL_ADC_REG_TRIG_EXT_RISINGFALLING                                                                              \
  (ADC_CFGR_EXTEN_1 | ADC_CFGR_EXTEN_0) /*!< ADC group regular conversion trigger polarity set to both rising and      \
                                           falling edges */
/**
 * @}
 */
...
#define LL_ADC_REG_CONV_SINGLE                                                                                         \
  (0x00000000UL) /*!< ADC conversions are performed in single mode: one conversion per trigger */
#define LL_ADC_REG_CONV_CONTINUOUS                                                                                     \
  (ADC_CFGR_CONT) /*!< ADC conversions are performed in continuous mode: after the first trigger, following            \
...
#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                                                                \
  (ADC_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in limited mode (one shot mode): DMA transfer      \
                      requests are stopped when number of DMA data transfers (number of ADC conversions) is reached.   \
                      This ADC mode is intended to be used with DMA mode non-circular. */
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                                                              \
  (ADC_CFGR_DMACFG | ADC_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in unlimited mode: DMA transfer  \
                                        requests are unlimited, whatever number of DMA data transferred (number of ADC \
                                        conversions). This ADC mode is intended to be used with DMA mode circular. */
/**
 * @}
 */
...
#define LL_ADC_REG_DFSDM_TRANSFER_ENABLE                                                                               \
  (ADC_CFGR_DFSDMCFG) /*!< ADC conversion data are transferred to DFSDM for post processing. The ADC conversion data   \
                         format must be 16-bit signed and right aligned, refer to reference manual. DFSDM transfer     \
...
#define LL_ADC_SAMPLINGTIME_COMMON_3C5_REPL_2C5                                                                        \
  (ADC_SMPR1_SMPPLUS) /*!< ADC additional sampling time 3.5 ADC clock cycles replacing 2.5 ADC clock cycles (this      \
                         applies to all channels mapped with selection sampling time 2.5 ADC clock cycles, whatever    \
                         channels mapped on ADC groups regular or injected). */
/**
 * @}
 */
#endif
...
#define LL_ADC_REG_OVR_DATA_PRESERVED                                                                                  \
  (0x00000000UL) /*!< ADC group regular behavior in case of overrun: data preserved */
#define LL_ADC_REG_OVR_DATA_OVERWRITTEN                                                                                \
  (ADC_CFGR_OVRMOD) /*!< ADC group regular behavior in case of overrun: data overwritten */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_SCAN_DISABLE                                                                                    \
  (0x00000000UL) /*!< ADC group regular sequencer disable (equivalent to sequencer of 1 rank: ADC conversion on only 1 \
                    channel) */
...
#define LL_ADC_REG_SEQ_SCAN_ENABLE_12RANKS                                                                             \
  (ADC_SQR1_L_3 | ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 12 ranks in the sequence   \
                                                */
...
#define LL_ADC_REG_SEQ_SCAN_ENABLE_14RANKS                                                                             \
  (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 14 ranks in the sequence   \
                                                */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_15RANKS                                                                             \
  (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 15 ranks in the sequence   \
                                                */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS                                                                             \
  (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 16 ranks in \
                                                                 the sequence */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_DISCONT_1RANK                                                                                   \
  (ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence interruption every rank   \
                     */
#define LL_ADC_REG_SEQ_DISCONT_2RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enabled with sequence     \
                                            interruption every 2 ranks */
#define LL_ADC_REG_SEQ_DISCONT_3RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence      \
                                            interruption every 3 ranks */
#define LL_ADC_REG_SEQ_DISCONT_4RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode      \
                                                                 enable with sequence interruption every 4 ranks */
#define LL_ADC_REG_SEQ_DISCONT_5RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence      \
                                            interruption every 5 ranks */
#define LL_ADC_REG_SEQ_DISCONT_6RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode      \
                                                                 enable with sequence interruption every 6 ranks */
#define LL_ADC_REG_SEQ_DISCONT_7RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode      \
...
#define LL_ADC_REG_SEQ_DISCONT_8RANKS                                                                                  \
  (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCNUM_0 |                                                      \
   ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence interruption every 8      \
                       ranks */
/**
 * @}
 */
...
#define LL_ADC_REG_RANK_1                                                                                              \
  (ADC_SQR1_REGOFFSET | ADC_REG_RANK_1_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 1 */
#define LL_ADC_REG_RANK_2                                                                                              \
  (ADC_SQR1_REGOFFSET | ADC_REG_RANK_2_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 2 */
#define LL_ADC_REG_RANK_3                                                                                              \
  (ADC_SQR1_REGOFFSET | ADC_REG_RANK_3_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 3 */
#define LL_ADC_REG_RANK_4                                                                                              \
  (ADC_SQR1_REGOFFSET | ADC_REG_RANK_4_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 4 */
#define LL_ADC_REG_RANK_5                                                                                              \
  (ADC_SQR2_REGOFFSET | ADC_REG_RANK_5_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 5 */
#define LL_ADC_REG_RANK_6                                                                                              \
  (ADC_SQR2_REGOFFSET | ADC_REG_RANK_6_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 6 */
...
#define LL_ADC_REG_RANK_10                                                                                             \
  (ADC_SQR3_REGOFFSET | ADC_REG_RANK_10_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 10 */
#define LL_ADC_REG_RANK_11                                                                                             \
  (ADC_SQR3_REGOFFSET | ADC_REG_RANK_11_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 11 */
#define LL_ADC_REG_RANK_12                                                                                             \
  (ADC_SQR3_REGOFFSET | ADC_REG_RANK_12_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 12 */
#define LL_ADC_REG_RANK_13                                                                                             \
  (ADC_SQR3_REGOFFSET | ADC_REG_RANK_13_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 13 */
#define LL_ADC_REG_RANK_14                                                                                             \
  (ADC_SQR3_REGOFFSET | ADC_REG_RANK_14_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 14 */
#define LL_ADC_REG_RANK_15                                                                                             \
  (ADC_SQR4_REGOFFSET | ADC_REG_RANK_15_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 15 */
#define LL_ADC_REG_RANK_16                                                                                             \
  (ADC_SQR4_REGOFFSET | ADC_REG_RANK_16_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 16 */
/**
 * @}
 */
...
#define LL_ADC_INJ_TRIG_SOFTWARE                                                                                       \
  (0x00000000UL) /*!< ADC group injected conversion trigger internal: SW start.. Trigger edge set to rising edge       \
                    (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                                                                  \
  (ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM1 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO2                                                                                 \
  (ADC_JSQR_JEXTSEL_3 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external        \
                                                          peripheral: TIM1 TRGO2. Trigger edge set to rising edge      \
                                                          (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                                                                   \
  (ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external        \
                                                          peripheral: TIM1 channel 4 event (capture compare: input     \
                                                          capture or output capture). Trigger edge set to rising edge  \
                                                          (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO                                                                                  \
  (ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external        \
                                                          peripheral: TIM2 TRGO. Trigger edge set to rising edge       \
                                                          (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                                                   \
  (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM2 channel 1  \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO                                                                                  \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM3 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1                                                                                   \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |                                                      \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM3 channel 1  \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3                                                                                   \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                                      \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM3 channel 3  \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4                                                                                   \
  (ADC_JSQR_JEXTSEL_2 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external        \
                                                          peripheral: TIM3 channel 4 event (capture compare: input     \
                                                          capture or output capture). Trigger edge set to rising edge  \
                                                          (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                                                                  \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM4 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM6_TRGO                                                                                  \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                                      \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM6 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                                                   \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                                      \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM8 channel 4  \
                                     event (capture compare: input capture or output capture). Trigger edge set to     \
                                     rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO                                                                                  \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_0 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM8 TRGO.      \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2                                                                                 \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM8 TRGO2.     \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO                                                                                 \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: TIM15 TRGO.     \
                                     Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                                                \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                                                           \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external peripheral: external        \
...
#define LL_ADC_INJ_TRIG_EXT_RISING                                                                                     \
  (ADC_JSQR_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set to rising edge */
#define LL_ADC_INJ_TRIG_EXT_FALLING                                                                                    \
  (ADC_JSQR_JEXTEN_1) /*!< ADC group injected conversion trigger polarity set to falling edge */
#define LL_ADC_INJ_TRIG_EXT_RISINGFALLING                                                                              \
  (ADC_JSQR_JEXTEN_1 | ADC_JSQR_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set to both rising and   \
                                             falling edges */
/**
 * @}
 */
...
#define LL_ADC_INJ_TRIG_INDEPENDENT                                                                                    \
  (0x00000000UL) /*!< ADC group injected conversion trigger independent. Setting mandatory if ADC group injected       \
                    injected trigger source is set to an external trigger. */
#define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                                                               \
  (ADC_CFGR_JAUTO) /*!< ADC group injected conversion trigger from ADC group regular. Setting compliant only with      \
                      group injected trigger source set to SW start, without any further action on  ADC group injected \
                      conversion start or stop: in this case, ADC group injected is controlled only from ADC group     \
                      regular. */
/**
 * @}
 */
...
#define LL_ADC_INJ_QUEUE_2CONTEXTS_LAST_ACTIVE                                                                         \
  (0x00000000UL) /* Group injected sequence context queue is enabled and can contain up to 2 contexts. When all        \
                    contexts have been processed, the queue maintains the last context active perpetually. */
#define LL_ADC_INJ_QUEUE_2CONTEXTS_END_EMPTY                                                                           \
  (ADC_CFGR_JQM) /* Group injected sequence context queue is enabled and can contain up to 2 contexts. When all        \
                    contexts have been processed, the queue is empty and injected group triggers are disabled. */
#define LL_ADC_INJ_QUEUE_DISABLE                                                                                       \
  (ADC_CFGR_JQDIS) /* Group injected sequence context queue is disabled: only 1 sequence can be configured and is      \
                      active perpetually. */
/**
 * @}
 */
...
#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                                                    \
  (0x00000000UL) /*!< ADC group injected sequencer disable (equivalent to sequencer of 1 rank: ADC conversion on only  \
                    1 channel) */
...
#define LL_ADC_INJ_SEQ_DISCONT_1RANK                                                                                   \
  (ADC_CFGR_JDISCEN) /*!< ADC group injected sequencer discontinuous mode enable with sequence interruption every rank \
                      */
/**
 * @}
 */
...
#define LL_ADC_INJ_RANK_1                                                                                              \
  (ADC_JDR1_REGOFFSET | ADC_INJ_RANK_1_JSQR_BITOFFSET_POS) /*!< ADC group injected sequencer rank 1 */
#define LL_ADC_INJ_RANK_2                                                                                              \
  (ADC_JDR2_REGOFFSET | ADC_INJ_RANK_2_JSQR_BITOFFSET_POS) /*!< ADC group injected sequencer rank 2 */
#define LL_ADC_INJ_RANK_3                                                                                              \
  (ADC_JDR3_REGOFFSET | ADC_INJ_RANK_3_JSQR_BITOFFSET_POS) /*!< ADC group injected sequencer rank 3 */
#define LL_ADC_INJ_RANK_4                                                                                              \
  (ADC_JDR4_REGOFFSET | ADC_INJ_RANK_4_JSQR_BITOFFSET_POS) /*!< ADC group injected sequencer rank 4 */
/**
 * @}
 */
...
#define LL_ADC_SAMPLINGTIME_24CYCLES_5                                                                                 \
  (ADC_SMPR2_SMP10_1 | ADC_SMPR2_SMP10_0)                  /*!< Sampling time 24.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_92CYCLES_5                                                                                 \
  (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_0) /*!< Sampling time 92.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_247CYCLES_5                                                                                \
  (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1) /*!< Sampling time 247.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_640CYCLES_5                                                                                \
  (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 | ADC_SMPR2_SMP10_0) /*!< Sampling time 640.5 ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_SINGLE_ENDED                                                                                            \
  (ADC_CALFACT_CALFACT_S) /*!< ADC channel ending set to single ended (literal also used to set calibration mode) */
#define LL_ADC_DIFFERENTIAL_ENDED                                                                                      \
  (ADC_CR_ADCALDIF | ADC_CALFACT_CALFACT_D) /*!< ADC channel ending set to differential (literal also used to set      \
                                               calibration mode) */
#define LL_ADC_BOTH_SINGLE_DIFF_ENDED                                                                                  \
  (LL_ADC_SINGLE_ENDED | LL_ADC_DIFFERENTIAL_ENDED) /*!< ADC channel ending set to both single ended and differential  \
                                                       (literal used only to set calibration factors) */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_REG                                                                                    \
  (ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR_AWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted by      \
                                                   group regular only */
#define LL_ADC_AWD_ALL_CHANNELS_INJ                                                                                    \
  (ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR_JAWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted by     \
                                                    group injected only */
#define LL_ADC_AWD_ALL_CHANNELS_REG_INJ                                                                                \
  (ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN) /*!< ADC analog watchdog monitoring of all          \
...
#define LL_ADC_AWD_CHANNEL_0_REG                                                                                       \
  ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                        \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_0_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_1_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_2_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_3_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_4_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_6_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_8_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_9_REG_INJ                                                                                   \
  ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_10_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_11_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_12_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_13_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_14_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_15_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_16_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_17_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
...
#define LL_ADC_AWD_CHANNEL_18_REG                                                                                      \
  ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                       \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN18, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_18_INJ                                                                                      \
  ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                                      \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN18, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_18_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                    \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN18, converted by either group regular or injected */
#define LL_ADC_AWD_CH_VREFINT_REG                                                                                      \
  ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                  \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to VrefInt: Internal        \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                                                   \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                               \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                                                                   \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                              \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Temperature sensor,      \
...
#define LL_ADC_AWD_CH_VBAT_REG                                                                                         \
  ((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                     \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Vbat/3: Vbat voltage     \
                        through a divider ladder of factor 1/3 to have Vbat always below Vdda, converted by group      \
                        regular only */
...
#define LL_ADC_AWD_CH_VBAT_REG_INJ                                                                                     \
  ((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                                  \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Vbat/3: Vbat voltage     \
                        through a divider ladder of factor 1/3 to have Vbat always below Vdda */
#if defined(ADC1) && !defined(ADC2)
#define LL_ADC_AWD_CH_DAC1CH1_REG                                                                                      \
  ((LL_ADC_CHANNEL_DAC1CH1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                  \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC1, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH1_INJ                                                                                      \
  ((LL_ADC_CHANNEL_DAC1CH1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                                 \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC1, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH1_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_DAC1CH1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                               \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC1, converted by either group regular or injected */
#define LL_ADC_AWD_CH_DAC1CH2_REG                                                                                      \
  ((LL_ADC_CHANNEL_DAC1CH2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                                  \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC1, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH2_INJ                                                                                      \
  ((LL_ADC_CHANNEL_DAC1CH2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                                 \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC1, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH2_REG_INJ                                                                                  \
  ((LL_ADC_CHANNEL_DAC1CH2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                               \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC1, converted by either group regular or injected */
#elif defined(ADC2)
#define LL_ADC_AWD_CH_DAC1CH1_ADC2_REG                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                             \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC2, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH1_ADC2_INJ                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                            \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC2, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH1_ADC2_REG_INJ                                                                             \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                          \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC2, converted by either group regular or injected */
#define LL_ADC_AWD_CH_DAC1CH2_ADC2_REG                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                             \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC2, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH2_ADC2_INJ                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                            \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC2, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH2_ADC2_REG_INJ                                                                             \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                          \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC2, converted by either group regular or injected */
#if defined(ADC3)
#define LL_ADC_AWD_CH_DAC1CH1_ADC3_REG                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                             \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC3, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH1_ADC3_INJ                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                            \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC3, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH1_ADC3_REG_INJ                                                                             \
  ((LL_ADC_CHANNEL_DAC1CH1_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                          \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 1, channel  \
                        specific to ADC3, converted by either group regular or injected */
#define LL_ADC_AWD_CH_DAC1CH2_ADC3_REG                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                                             \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC3, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH2_ADC3_INJ                                                                                 \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |                                            \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC3, converted by group injected only */
#define LL_ADC_AWD_CH_DAC1CH2_ADC3_REG_INJ                                                                             \
  ((LL_ADC_CHANNEL_DAC1CH2_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |                          \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to DAC1 channel 2, channel  \
                        specific to ADC3, converted by either group regular or injected */
#endif               /* ADC3 */
#endif               /* ADC1 && !ADC2 */
...
#define LL_ADC_AWD_THRESHOLDS_HIGH_LOW                                                                                 \
  (ADC_TR1_HT1 | ADC_TR1_LT1) /*!< ADC analog watchdog both thresholds high and low concatenated into the same data */
/**
 * @}
 */
...
#define LL_ADC_OVS_GRP_REGULAR_CONTINUED                                                                               \
  (ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of ADC group regular. If group injected interrupts group      \
                       regular: when ADC group injected is triggered, the oversampling on ADC group regular is         \
                       temporary stopped and continued afterwards. */
#define LL_ADC_OVS_GRP_REGULAR_RESUMED                                                                                 \
  (ADC_CFGR2_ROVSM | ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of ADC group regular. If group injected     \
                                         interrupts group regular: when ADC group injected is triggered, the           \
                                         oversampling on ADC group regular is resumed from start (oversampler buffer   \
                                         reset). */
...
#define LL_ADC_OVS_GRP_INJ_REG_RESUMED                                                                                 \
  (ADC_CFGR2_JOVSE | ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of both ADC groups regular and injected. If \
                                         group injected interrupting group regular: when ADC group injected is         \
                                         triggered, the oversampling on ADC group regular is resumed from start        \
...
#define LL_ADC_OVS_REG_CONT                                                                                            \
  (0x00000000UL) /*!< ADC oversampling discontinuous mode: continuous mode (all conversions of oversampling ratio are  \
                    done from 1 trigger) */
#define LL_ADC_OVS_REG_DISCONT                                                                                         \
  (ADC_CFGR2_TROVS) /*!< ADC oversampling discontinuous mode: discontinuous mode (each conversion of oversampling      \
                       ratio needs a trigger) */
/**
 * @}
 */
...
#define LL_ADC_OVS_RATIO_2                                                                                             \
  (0x00000000UL) /*!< ADC oversampling ratio of 2 (2 ADC conversions are performed, sum of these conversions data is   \
                    computed to result as the ADC oversampling conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_4                                                                                             \
  (ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 4 (4 ADC conversions are performed, sum of these conversions data  \
                        is computed to result as the ADC oversampling conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_8                                                                                             \
  (ADC_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 8 (8 ADC conversions are performed, sum of these conversions data  \
                        is computed to result as the ADC oversampling conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_16                                                                                            \
  (ADC_CFGR2_OVSR_1 | ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 16 (16 ADC conversions are performed, sum of    \
                                           these conversions data is computed to result as the ADC oversampling        \
                                           conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_32                                                                                            \
  (ADC_CFGR2_OVSR_2) /*!< ADC oversampling ratio of 32 (32 ADC conversions are performed, sum of these conversions     \
                        data is computed to result as the ADC oversampling conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_64                                                                                            \
  (ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 64 (64 ADC conversions are performed, sum of    \
                                           these conversions data is computed to result as the ADC oversampling        \
                                           conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_128                                                                                           \
  (ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 128 (128 ADC conversions are performed, sum of  \
                                           these conversions data is computed to result as the ADC oversampling        \
                                           conversion data (before potential shift) */
#define LL_ADC_OVS_RATIO_256                                                                                           \
  (ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_1 |                                                                               \
   ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 256 (256 ADC conversions are performed, sum of these conversions   \
                        data is computed to result as the ADC oversampling conversion data (before potential shift) */
/**
 * @}
 */
...
#define LL_ADC_OVS_SHIFT_NONE                                                                                          \
  (0x00000000UL) /*!< ADC oversampling no shift (sum of the ADC conversions data is not divided to result as the ADC   \
                    oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_1                                                                                       \
  (ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 1 (sum of the ADC conversions data is divided by 2 to result as    \
                        the ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_2                                                                                       \
  (ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 2 (sum of the ADC conversions data is divided by 4 to result as    \
                        the ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_3                                                                                       \
  (ADC_CFGR2_OVSS_1 | ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 3 (sum of the ADC conversions data is divided   \
                                           by 8 to result as the ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_4                                                                                       \
  (ADC_CFGR2_OVSS_2) /*!< ADC oversampling shift of 4 (sum of the ADC conversions data is divided by 16 to result as   \
                        the ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_5                                                                                       \
  (ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 5 (sum of the ADC conversions data is divided   \
                                           by 32 to result as the ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_6                                                                                       \
  (ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 6 (sum of the ADC conversions data is divided   \
                                           by 64 to result as the ADC oversampling conversion data) */
...
#define LL_ADC_OVS_SHIFT_RIGHT_8                                                                                       \
  (ADC_CFGR2_OVSS_3) /*!< ADC oversampling shift of 8 (sum of the ADC conversions data is divided by 256 to result as  \
                        the ADC oversampling conversion data) */
/**
 * @}
 */
...
#define LL_ADC_MULTI_DUAL_REG_SIMULT                                                                                   \
  (ADC_CCR_DUAL_2 | ADC_CCR_DUAL_1) /*!< ADC dual mode enabled: group regular simultaneous */
#define LL_ADC_MULTI_DUAL_REG_INTERL                                                                                   \
  (ADC_CCR_DUAL_2 | ADC_CCR_DUAL_1 | ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: Combined group regular interleaved */
#define LL_ADC_MULTI_DUAL_INJ_SIMULT                                                                                   \
  (ADC_CCR_DUAL_2 | ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: group injected simultaneous */
#define LL_ADC_MULTI_DUAL_INJ_ALTERN                                                                                   \
  (ADC_CCR_DUAL_3 | ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: group injected alternate trigger. Works only with      \
                                       external triggers (not internal SW start) */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_SIM                                                                              \
  (ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected simultaneous */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT                                                                              \
  (ADC_CCR_DUAL_1) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected alternate trigger  \
                    */
#define LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM                                                                              \
  (ADC_CCR_DUAL_1 | ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: Combined group regular interleaved + group injected    \
                                       simultaneous */
/**
 * @}
 */
...
#define LL_ADC_MULTI_REG_DMA_EACH_ADC                                                                                  \
  (0x00000000UL) /*!< ADC multimode group regular conversions are transferred by DMA: each ADC uses its own DMA        \
                    channel, with its individual DMA transfer settings */
#define LL_ADC_MULTI_REG_DMA_LIMIT_RES12_10B                                                                           \
  (ADC_CCR_MDMA_1) /*!< ADC multimode group regular conversions are transferred by DMA, one DMA channel for both ADC   \
                      (DMA of ADC master), in limited mode (one shot mode): DMA transfer requests are stopped when     \
                      number of DMA data transfers (number of ADC conversions) is reached. This ADC mode is intended   \
                      to be used with DMA mode non-circular. Setting for ADC resolution of 12 and 10 bits */
#define LL_ADC_MULTI_REG_DMA_LIMIT_RES8_6B                                                                             \
  (ADC_CCR_MDMA_1 | ADC_CCR_MDMA_0) /*!< ADC multimode group regular conversions are transferred by DMA, one DMA       \
                                       channel for both ADC (DMA of ADC master), in limited mode (one shot mode): DMA  \
                                       transfer requests are stopped when number of DMA data transfers (number of ADC  \
                                       conversions) is reached. This ADC mode is intended to be used with DMA mode     \
                                       non-circular. Setting for ADC resolution of 8 and 6 bits */
#define LL_ADC_MULTI_REG_DMA_UNLMT_RES12_10B                                                                           \
  (ADC_CCR_DMACFG | ADC_CCR_MDMA_1) /*!< ADC multimode group regular conversions are transferred by DMA, one DMA       \
                                       channel for both ADC (DMA of ADC master), in unlimited mode: DMA transfer       \
                                       requests are unlimited, whatever number of DMA data transferred (number of ADC  \
                                       conversions). This ADC mode is intended to be used with DMA mode circular.      \
                                       Setting for ADC resolution of 12 and 10 bits */
#define LL_ADC_MULTI_REG_DMA_UNLMT_RES8_6B                                                                             \
  (ADC_CCR_DMACFG | ADC_CCR_MDMA_1 |                                                                                   \
   ADC_CCR_MDMA_0) /*!< ADC multimode group regular conversions are transferred by DMA, one DMA channel for both ADC   \
                      (DMA of ADC master), in unlimited mode: DMA transfer requests are unlimited, whatever number of  \
                      DMA data transferred (number of ADC conversions). This ADC mode is intended to be used with DMA  \
                      mode circular. Setting for ADC resolution of 8 and 6 bits */
/**
 * @}
 */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_1CYCLE                                                                               \
  (0x00000000UL) /*!< ADC multimode delay between two sampling phases: 1 ADC clock cycle */
#define LL_ADC_MULTI_TWOSMP_DELAY_2CYCLES                                                                              \
  (ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 2 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_3CYCLES                                                                              \
  (ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 3 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES                                                                              \
  (ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 4 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES                                                                              \
  (ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling phases: 5 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES                                                                              \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 6 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES                                                                              \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 7 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES                                                                              \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 8 ADC    \
                                                           clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_9CYCLES                                                                              \
  (ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling phases: 9 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_10CYCLES                                                                             \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 10 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_11CYCLES                                                                             \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 11 ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_12CYCLES                                                                             \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 12 ADC   \
                                                           clock cycles */
/**
 * @}
 */
...
#define LL_ADC_MULTI_MASTER                                                                                            \
  (ADC_CDR_RDATA_MST)                          /*!< In multimode, selection among several ADC instances: ADC master    \
                                                */
...
#define LL_ADC_MULTI_MASTER_SLAVE                                                                                      \
  (ADC_CDR_RDATA_SLV | ADC_CDR_RDATA_MST) /*!< In multimode, selection among several ADC instances: both ADC master    \
                                             and ADC slave */
/**
 * @}
 */
...
#define LL_ADC_DELAY_INTERNAL_REGUL_STAB_US                                                                            \
  (20UL) /*!< Delay for ADC stabilization time (ADC voltage regulator start-up time) */
...
#define LL_ADC_DELAY_TEMPSENSOR_BUFFER_STAB_US                                                                         \
  (15UL) /*!< Delay for temperature sensor buffer stabilization time (starting from ADC enable, refer to @ref          \
            LL_ADC_Enable()) */
 ...
 *         (6) On STM32L4, parameter available on devices with several ADC instances.\n
 *         (7) On STM32L4, fast channel (0.188 us for 12-bit resolution (ADC conversion rate up to 5.33 Ms/s)).
 *             Other channels are slow channels (0.238 us for 12-bit resolution (ADC conversion rate up to 4.21
 * Ms/s)).\n (1, 2, 3, 4) For ADC channel read back from ADC register, comparison with internal channel parameter to be
 * done using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
 */
#define __LL_ADC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__)                                                                 \
  (((__DECIMAL_NB__) <= 9UL) ?                                                                                         \
       (((__DECIMAL_NB__) << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) | (ADC_AWD2CR_AWD2CH_0 << (__DECIMAL_NB__)) |        \
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                          \
  (((__ADC_INSTANCE__) == ADC1) ?                                                                                      \
   ...
   ((__ADC_INSTANCE__) == ADC2) ?                                                                                      \
       (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_DAC1CH1_ADC2) ||                 \
        ((__CHANNEL__) == LL_ADC_CHANNEL_DAC1CH2_ADC2)) :                                                              \
   ((__ADC_INSTANCE__) == ADC3) ?                                                                                      \
       (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) ||                   \
        ((__CHANNEL__) == LL_ADC_CHANNEL_VBAT) || ((__CHANNEL__) == LL_ADC_CHANNEL_DAC1CH1_ADC3) ||                    \
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                          \
  (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) ||                        \
   ((__CHANNEL__) == LL_ADC_CHANNEL_VBAT) || ((__CHANNEL__) == LL_ADC_CHANNEL_DAC1CH1) ||                              \
 ...
 */
#if defined(ADC2)
#define __LL_ADC_MULTI_INSTANCE_MASTER(__ADCx__) ((((__ADCx__) == ADC2)) ? (ADC1) : (__ADCx__))
#else
...
#define __LL_ADC_CALC_VREFANALOG_VOLTAGE(__VREFINT_ADC_DATA__, __ADC_RESOLUTION__)                                     \
  (((uint32_t)(*VREFINT_CAL_ADDR) * VREFINT_CAL_VREF) /                                                                \
   __LL_ADC_CONVERT_DATA_RESOLUTION((__VREFINT_ADC_DATA__), (__ADC_RESOLUTION__), LL_ADC_RESOLUTION_12B))
...
#define __LL_ADC_CALC_TEMPERATURE(__VREFANALOG_VOLTAGE__, __TEMPSENSOR_ADC_DATA__, __ADC_RESOLUTION__)                 \
  ((((((int32_t)((__LL_ADC_CONVERT_DATA_RESOLUTION((__TEMPSENSOR_ADC_DATA__), (__ADC_RESOLUTION__),                    \
 ...
 * uV/DegCelsius). On STM32L4, refer to device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature sensor voltage typical value (at temperature
 * and Vref+ defined in parameters below) (unit: mV). On STM32L4, refer to device datasheet parameter "V30"
...
__STATIC_INLINE uint32_t LL_ADC_GetCalibrationFactor(ADC_TypeDef* ADCx, uint32_t SingleDiff)
{
  ...
  return (uint32_t)(READ_BIT(ADCx->CALFACT, (SingleDiff & ADC_SINGLEDIFF_CALIB_FACTOR_MASK)) >>
...
__STATIC_INLINE void LL_ADC_SetOffset(ADC_TypeDef* ADCx, uint32_t Offsety, uint32_t Channel, uint32_t OffsetLevel)
{
  ...
  MODIFY_REG(*preg, ADC_OFR1_OFFSET1_EN | ADC_OFR1_OFFSET1_CH | ADC_OFR1_OFFSET1,
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(ADC_TypeDef* ADCx)
{
  ...
  return ((TriggerSource & (ADC_REG_TRIG_SOURCE_MASK >> ShiftExten) & ADC_CFGR_EXTSEL) |
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerRanks(ADC_TypeDef* ADCx, uint32_t Rank)
{
  ...
  return (uint32_t)((READ_BIT(*preg, ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0 << (Rank & ADC_REG_RANK_ID_SQRX_MASK)) >>
                     (Rank & ADC_REG_RANK_ID_SQRX_MASK))
...
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource(ADC_TypeDef* ADCx)
{
  ...
  /* to match with triggers literals definition.                              */
  return ((TriggerSource & (ADC_INJ_TRIG_SOURCE_MASK >> ShiftJexten) & ADC_JSQR_JEXTSEL) |
...
__STATIC_INLINE void LL_ADC_SetChannelSamplingTime(ADC_TypeDef* ADCx, uint32_t Channel, uint32_t SamplingTime)
{
  ...
  /* other bits reserved for other purpose.                                   */
  __IO uint32_t* preg =
      __ADC_PTR_REG_OFFSET(ADCx->SMPR1, ((Channel & ADC_CHANNEL_SMPRX_REGOFFSET_MASK) >> ADC_SMPRX_REGOFFSET_POS));
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(ADC_TypeDef* ADCx, uint32_t Channel)
{
  ...
  return (uint32_t)(READ_BIT(*preg, ADC_SMPR1_SMP0 << ((Channel & ADC_CHANNEL_SMPx_BITOFFSET_MASK) >>
...
__STATIC_INLINE void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef* ADCx, uint32_t AWDy, uint32_t AWDChannelGroup)
{
  ...
  /* containing other bits reserved for other purpose.                        */
  __IO uint32_t* preg =
      __ADC_PTR_REG_OFFSET(ADCx->CFGR, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK) >> ADC_AWD_CRX_REGOFFSET_POS) +
                                           ((AWDy & ADC_AWD_CR12_REGOFFSETGAP_MASK) * ADC_AWD_CR12_REGOFFSETGAP_VAL));

  MODIFY_REG(*preg, (AWDy & ADC_AWD_CR_ALL_CHANNEL_MASK), AWDChannelGroup & AWDy);
}
  ...
  if (AnalogWDMonitChannels != 0UL)
  {
    if (AWDy == LL_ADC_AWD1)
    {
      if ((AnalogWDMonitChannels & ADC_CFGR_AWD1SGL) == 0UL)
      {
        ...
        AnalogWDMonitChannels = ((AnalogWDMonitChannels | (ADC_AWD_CR23_CHANNEL_MASK)) & (~(ADC_CFGR_AWD1CH)));
      }
      else
      {
        /* AWD monitoring a single channel */
        AnalogWDMonitChannels =
            (AnalogWDMonitChannels | (ADC_AWD2CR_AWD2CH_0 << (AnalogWDMonitChannels >> ADC_CFGR_AWD1CH_Pos)));
      }
    }
    else
    {
      ...
      {
        /* AWD monitoring a group of channels */
        AnalogWDMonitChannels = (ADC_AWD_CR23_CHANNEL_MASK | ((ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN)));
      }
      else
      {
        /* AWD monitoring a single channel */
        /* AWD monitoring a group of channels */
        AnalogWDMonitChannels = (AnalogWDMonitChannels | (ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) |
                                                     ...
                                                     uint32_t AWDThresholdLowValue)
{
  ...
  /* containing other bits reserved for other purpose.                        */
  __IO uint32_t* preg =
      __ADC_PTR_REG_OFFSET(ADCx->TR1, ((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS));
